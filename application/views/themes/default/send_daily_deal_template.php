                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#f9f9f9" style="border:1px solid #d2d2d2;">
                                                <tr>
                                                    <td valign="middle" width="300">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                                            <tr>
                                                                <td align="center" style="font:normal 24px arial;"><a style="color:#1e2023;text-decoration: none;" href="<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $products->deal_title; ?> "><?php echo ucfirst(substr($products->deal_title, 0, 20)) ; ?></a></td>
                                                            </tr>
                                                            <tr height="5">
                                                                <td></td>
                                                            </tr>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#f9f9f9" style="border:1px solid #d2d2d2;">
                                                <tr>
                                                    <td valign="middle" width="300">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                                            <tr>
                                                                <td align="center" style="font:normal 24px arial;"><a style="color:#1e2023;text-decoration: none;" href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo ucfirst($deals->deal_title) ; ?>"><?php echo ucfirst(substr($deals->deal_title, 0, 20)) ; ?></a></td>
                                                            </tr>
                                                            <tr height="5">
                                                                <td></td>
                                                            </tr>
                                                ...
                                                <?php } else { ?>
                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>"><img width="396px" height="246px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>  
                                                <?php } ?> 
                                                    </td>
                                                </tr>
                                            </table> 
                                                    ...
                                                    <td valign="middle" width="179">
                                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                                            <tr height="252">
                                                                ...
                                                                <?php } else { ?>
                                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>" style="display: block;" ><img width="175px" height="252px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>
                                                                <?php } ?> 
                                                                </td>
                                                            </tr>
                                                            <tr height="10">
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                        <tr>
                                                                            <td>
                                                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="Buy now">
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" valign="middle">
                                                        ...
                                                        <?php } else { ?>
                                                        <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="<?php echo $auction->deal_title; ?>"><img width="396px" height="246px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"   alt="<?php echo $auction->deal_title; ?>" title="<?php echo $auction->deal_title; ?>" border="0" /></a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                            </table> 
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#f9f9f9" style="border:1px solid #d2d2d2; padding:15px;">
                                                ...
                                                <?php if (($i != 1) && $i <= 4) { ?>
                                                    ...
                                                    <td valign="middle" width="158" bgcolor="#ffffff"  style="border:1px dotted #c7c7c7;padding:10px;">
                                                        ...
                                                        <?php } else { ?>
                                                        <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="<?php echo $auction->deal_title; ?>"><img width="156px" height="108px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"   alt="<?php echo $auction->deal_title; ?>" title="<?php echo $auction->deal_title; ?>" border="0" /></a>
                                                        <?php }?>
                                                                </td>
                                                            </tr>                                                                                                                        
                                                            <tr height="10">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="Buy now">
                                                                        <img src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/new/email_buy_bt.png" alt="Buy now" />
                                                                    </a>
                                                                </td>
                                                            </tr>
