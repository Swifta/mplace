<div class="contianer_outer1">
    <div class="contianer_inner">
        ...
        <?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $u->deal_key . '_1' . '.png')) { ?>
                                            <a class="winner_list_deal_image" href="<?php echo PATH . 'auction/' . $u->deal_key . '/' . $u->url_title . '.html'; ?>" title="<?php echo $u->deal_title; ?>">
        ...
        <?php } else { ?>
                                            <a class="winner_list_deal_image" href="<?php echo PATH . 'auction/' . $u->deal_key . '/' . $u->url_title . '.html'; ?>" title="<?php echo $this->Lang['IMAGE']; ?>">
