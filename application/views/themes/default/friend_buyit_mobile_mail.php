                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td style=" ">
                                                        <p style="width:193px;font:normal 12px arial; color:#696969; margin:0px; padding-bottom: 10px;"><a style="text-decoration: none;font:normal 12px arial; color:#696969;"href="<?php echo PATH.'deals/'.$R->deal_key.'/'.$R->url_title.'.html';?>"><?php echo $R->deal_title; ?></a></p>
                                                    </td>
                                                    <td  style="">
                                                        <table>
                                                            <tr>
