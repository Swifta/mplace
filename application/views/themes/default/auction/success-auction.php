                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="bs_row success_close">                                                    
                                                    <input class="sign_submit" type="button" value="<?php echo $this->Lang['CLS_WIN']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>auction/<?php echo $this->deal_key ; ?>/<?php echo $this->url_title; ?>.html'" >
                                                </div>
                                            </li>
