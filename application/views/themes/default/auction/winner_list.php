<?php defined('SYSPATH') OR die('No direct access allowed.'); ?>
    ...
    <?php /*<img src="<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" >*/ ?></a>
                                ...
                                <div class="product_listing_detail">
                                    ...
                                    <h2><a href="<?php echo PATH.'auction/'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo substr($deals->deal_title,0,40)."..";?>"><?php echo substr(ucfirst($deals->deal_title),0,100);?></a></h2>
                                    <div class="bid_cont">
                                        <div class="bid_value">
