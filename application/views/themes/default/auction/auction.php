...
<div class="contianer_outer">
    ...
    <?php } ?>
     ...
     <?php if (count($this->view_hot_deals_list ) > 0) { ?>
                            ...
                            <ul>
                             <?php
                                ...
                                $size = getimagesize($image_url);
                                        ?>
						<a href="<?php echo PATH.'auction/'.$h->deal_key.'/'.$h->url_title.'.html';?>" title="<?php echo $h->deal_title; ?>">
						 <?php if(($size[0] > 170) && ($size[1] > AUCTION_LIST_HEIGHT)) { ?>
							<img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$h->deal_key.'_1'.'.png'?>&w=170&h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>" title="<?php echo $h->deal_title; ?>" border="0" />
							<?php } else { ?>
                                 <img src="<?php echo PATH .'images/auction/1000_800/'.$h->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
					...
					<?php } else { ?>
						<a href="<?php echo PATH.'auction/'.$h->deal_key.'/'.$h->url_title.'.html';?>" title="<?php echo $h->deal_title; ?>"><img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_auctions_list.png&w=170&h=<?php echo AUCTION_LIST_HEIGHT; ?>"  alt="<?php echo $h->deal_title; ?>" title="<?php echo $h->deal_title; ?>" border="0" /></a>
					<?php }?>
                                    </div>
			...
			<?php
					...
					<?php } else { ?>
                                ...
                                <?php } ?>
                                        ...
                                        <?php } else { ?>
                                            <a href="<?php echo PATH . 'auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
					<img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&w=<?php echo PRODUCT_LIST_WIDTH; ?>&h=<?php echo PRODUCT_LIST_HEIGHT; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />
					</a>
                                        <?php } ?>
