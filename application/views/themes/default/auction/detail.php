...
<?php /*<img src="<?php echo PATH . 'images/auction/220_160/' . $deals1->deal_key . '_1' . '.png'; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />*/ ?></a>
                                        <?php } else { ?>
                                            <a href="<?php echo PATH.'resize.php';?>?src=<?php echo PATH . 'auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>&w=<?php echo AUCTION_DETAIL_WIDTH; ?>&h=<?php echo AUCTION_DETAIL_HEIGHT; ?>" title="<?php echo $deals1->deal_title; ?>">
