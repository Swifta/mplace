    ...
    <?php } ?>
                            ...
                            <ul>
                             <?php
                                ...
                                $size = getimagesize($image_url);
                                        ?>
                                                    <a href="<?php echo PATH . 'deals/' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>">
            ...
            <?php } ?>
                                    ...
                                    <div class="hot_ptoduct_details">
                                        <a class="cursor" href="<?php echo PATH . 'deals/' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"><h2><?php echo substr(ucfirst($h->deal_title), 0, 100); ?></h2></a>
                                        <span>
                                        <b><?php echo $symbol . " " . $h->deal_value; ?></b>
                                        <a href="<?php echo PATH . 'deals/' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"  class="more_details"></a>
                                        </span>
                                    </div>
                                </li>
                                <?php } ?>
...
<?php if (count($this->view_deals_list) > 0) { ?>
                ...
                <?php if ($this->session->get('cate') != "") { ?> <?php $url = $this->session->get('cate'); ?> <?php } else { ?> <?php $url = $deals->category_url; ?>  <?php } ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <img src="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_1' . '.png' ?>&w=168&h=180" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" />
                                                             <?php } else { ?>
                                                                <img src="<?php echo PATH .'images/deals/1000_800/'.$deals->deal_key.'_1'.'.png'?>" />
                                                                <?php } ?>   
                                                                </a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>"><img src="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&w=168&h=180"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>
                                                        <?php } ?>   
