                    ...
                    <div class="deal_comment_block">
                        <div class="deal_address">
                            ...
                            <address class="deal_map_address">
                                 <h3><a href="<?php echo PATH . 'stores/' . $deals->store_key . '/' . $deals->store_url_title . '.html'; ?>" title="<?php echo $deals->store_name; ?>"><?php echo $deals->store_name; ?></a></h3>
        ...
        <?php /* <p> <?php echo $this->Lang['FEAT_DEALS']; ?></p> */ ?>
                ...
                <?php if (file_exists(DOCROOT . 'images/deals/1000_800/' . $deals1->deal_key . '_1' . '.png')) { 
                 $image_url = PATH . 'images/deals/1000_800/' . $deals1->deal_key . '_1' . '.png';
                                $size = getimagesize($image_url);
                ?>
                                                                <a href="<?php echo PATH . 'deals/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
                ...
                ?>
                                                                <a class="cursor" href="<?php echo PATH . 'deals/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>"><?php echo substr(ucfirst($deals1->deal_title), 0, 100); ?></a>
                                                            </h2>
                ...
                <?php /* <p><?php //echo $symbol . " " . $deals->deal_price; ?></p> */ ?>
                                                            ...
                                                            <a class="buy_it list_buy_it" href="<?php echo PATH . 'deals/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </li>
