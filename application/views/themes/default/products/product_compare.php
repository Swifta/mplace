                                                ...
                                                <?php foreach ($this->product_compare as $c) {  ?>
                                                    <td class="name" valign="top;">  
                                                        <div class="produt_compare_title clearfix">
                                                            <a class="compare_deal_title" title="<?php echo $c['deal_title']; ?>" href="<?php echo PATH . 'product/' . $c['deal_key'] . '/' . $c['url_title']; ?>.html"><?php echo $c['deal_title']; ?></a>                                                        
                                                        ...
                                                        <div class="product_compare_image_sec">
                                                            ...
                                                            <a class="buy_it compare_view_it" href="<?php echo PATH . 'product/' . $c['deal_key'] . '/' . $c['url_title'] . '.html'; ?>" title="<?php echo $this->Lang['VIEW_PRODUCT']; ?>"><?php echo $this->Lang['VIEW_PRODUCT']; ?></a>
                                                        </div>
                                                    </td>
                                                    <?php  }  ?>
                                            </tr>
