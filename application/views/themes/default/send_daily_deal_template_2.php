                                                                    ...
                                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                                                        <tr>
                                                                            <td align="center" style="font:bold 16px arial;color:#1e2023;">
                                                                                <a href="<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?>"  style="color:#1e2023;text-decoration: none;"><?php echo ucfirst(substr($products->deal_title, 0, 25)) ; ?></a>
                                                                            </td>
                                                                        </tr>
                                   ...
                                   <?php } ?>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #d2d2d2;">
                                                ...
                                                <?php } else { ?>
                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>" style="display: block;"><img width="349px" height="298px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>  
                                                <?php } ?> 
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" border="0"  width="100%" >
                                                            <tr>
                                                                <td align="center" style="color:#000;font:normal 40px georgia;">                                                                    
                                                                    <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo ucfirst(substr($deals->deal_title, 0, 20)) ; ?>" style="color:#000;text-decoration: none;"><?php echo ucfirst(substr($deals->deal_title, 0, 20)) ; ?></a>
                                                                </td>
                                                            </tr>                                                            
                                                            <tr height="5">
                                                                <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <?php if (($i != 1) && $i <= 4) { ?>                                                
                                                ...
                                                <?php } else { ?>
                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>" style="display: block;" ><img width="190px" height="180px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>  
                                                <?php } ?> 
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td valign="middle">
                                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                                                                        <tr>
                                                                            <td align="center" style="font:bold 16px arial;color:#1e2023;">
                                                                                <a href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo ucfirst(substr($deals->deal_title, 0, 20)) ; ?>" style="color:#1e2023;text-decoration: none;"><?php echo ucfirst(substr($deals->deal_title, 0, 20)) ; ?></a>
                                                                            </td>                                                                            
                                                                        </tr>
                                                                        <tr height="10"><td></td></tr>
                                                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                <tr height="298">
                                                    <td width="350" align="center" valign="middle">
                                                        ...
                                                        <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="<?php echo $auction->deal_title; ?>" style="display: block;">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" border="0"  width="100%" >
                                                            ...
                                                            <tr>
                                                                <td align="center" style="font:normal 40px arial;color:#2D5B75;">                                                                    
                                                                    <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="Sweatshirts" style="color:#2D5B75;text-decoration: none;">BID NOW</a>
                                                                </td>
                                                            </tr>                                                                                                                                                                                    
                                                        </table>
                                                    </td>                                                    
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <?php if (($i != 1) && $i <= 4) { ?>                                                   
                                                    <td valign="middle" width="216" style="border:1px solid #d2d2d2;">
                                                        ...
                                                        <?php } else { ?>
                                                        <a href="<?php echo PATH.'auction/'.$auction->deal_key.'/'.$auction->url_title.'.html';?>" title="<?php echo $auction->deal_title; ?>"><img width="180px" height="200px;" src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/no-image/deal_list_no_image.png"   alt="<?php echo $auction->deal_title; ?>" title="<?php echo $auction->deal_title; ?>" border="0" /></a>
                                                        <?php }?>
                                                                </td>
                                                            </tr>
                                                            <tr height="5"><td></td></tr>
