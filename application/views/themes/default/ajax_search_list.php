						...
						<?php } ?>
						 ...
						 if(strlen($name) > 40) { 
							$name = substr($name, 0, 40) . "...";
                                                ...
                                                <a href="<?php echo PATH.'product/'.$p->deal_key.'/'.$p->url_title.'.html';?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'product/'.$p->deal_key.'/'.$p->url_title.'.html';?>" title="<?php echo $this->Lang['ADD_TO_CART']; ?>">
					...
					<!-- for Deal  -->
						...
						<?php } ?>
						 ...
						 if(strlen($name) > 40) { 
						    ...
						    <artical class="search_list_info">
                                                <a href="<?php echo PATH . 'deals/' . $d->deal_key . '/' . $d->url_title . '.html'; ?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'deals/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>">
...
<!-- for Auction  -->
						...
						<?php  foreach($this->search_category  as $ca ) { 
						 ...
						 ?>
										...
										<span class="category_sub_list">
                                                     <artical class="search_list_img">			
							<a href="<?php echo PATH . 'auction/' . $a->deal_key . '/' . $a->url_title . '.html'; ?>"  title="<?php echo $a->deal_title; ?>" >
						...
						<artical class="search_list_info">
                                                <a href="<?php echo PATH . 'auction/' . $a->deal_key . '/' . $a->url_title . '.html'; ?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'auction/'.$a->deal_key.'/'.$a->url_title.'.html';?>" title="<?php echo $this->Lang['BID_NOW1']; ?>">
