<?php if(count($this->store_details) > 0){ ?>	
	<?php  foreach( $this->store_details as $stores){?>	
	 <div class="feture_deal_listing_1">                                    
          ...
          <a href="<?php echo PATH.'stores/'.$stores->store_key.'/'.$stores->store_url_title.'.html';?>" >
<img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH .'images/merchant/600_370/'.$stores->merchant_id.'_'.$stores->store_id.'.png'?>&w=<?php echo STORE_LIST_WIDTH; ?>&h=<?php echo STORE_LIST_HEIGHT; ?>" alt="<?php echo $stores->store_name; ?>" title="<?php echo $stores->store_name; ?>" />
...
<?php /* <img src="<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_stores_list.png"   alt="<?php echo $stores->store_name; ?>" title="<?php echo $stores->store_name; ?>"  >*/ ?></a>
          ...
          <?php }?>                                                 
                                        ...
                                        <a class="bot_square" href="<?php echo PATH.'stores/'.$stores->store_key.'/'.$stores->store_url_title.'.html';?>" title="<?php echo $stores->store_name; ?>"><?php echo substr(ucfirst($stores->store_name),0,100);?></a>
