...
<?php /*<img src="<?php echo PATH.'images/products/290_215/'.$p->deal_key.'_1'.'.png';?>" alt="<?php echo $p->deal_title; ?>"   border="0" />*/ ?></a>
					<?php } else { ?>
					<a href="<?php echo PATH.'product/'.$p->deal_key.'/'.$p->url_title.'.html';?>" title="<?php echo $p->deal_title; ?>"><img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&w=173&h=252" alt="<?php echo $p->deal_title; ?>" /></a>
					<?php  }?>                                             
                                        <a class="sold_out_bt"><?php echo $this->Lang['SOLD_OUT2']; ?></a>
                                         </div>
                                            <div class="product_listing_detail">
                                               <?php /** <h2>Electronics</h2> **/ ?>
                                                <h2><a href="<?php echo PATH.'product/'.$p->deal_key.'/'.$p->url_title.'.html';?>" title="<?php echo $p->deal_title; ?>"><?php echo substr(ucfirst($p->deal_title),0,100); ?></a></h2>
                                            </div>
                                        </div> 
                                    </li>
                                    <?php }?>
                    ...
                    <!--   my carousel3  -->                                        
						...
						if (($d->maximum_deals_limit <= $d->purchase_count) || ($d->enddate < time())) {
                                ...
                                $size = getimagesize($image_url);
                                ?>
					<a href="<?php echo PATH.'deals/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>">
...
<?php /* <img src="<?php echo PATH.'images/deals/220_160/'.$d->deal_key.'_1'.'.png' ?>"  alt="<?php echo $d->deal_title; ?>" title="<?php echo $d->deal_title; ?>" border="0" />*/ ?></a>
				<?php } else { ?>
					<a href="<?php echo PATH.'deals/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>"><img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&w=173&h=252"  alt="<?php echo $d->deal_title; ?>" title="<?php echo $d->deal_title; ?>" border="0" /></a>
				<?php }?>
                                                    <a class="sold_out_bt"><?php echo $this->Lang['SOLD_OUT2']; ?></a>                                                    
                                                </div>
                                                <div class="product_listing_detail">
                                                    <h2><a href="<?php echo PATH.'deals/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>"><?php echo substr(ucfirst($d->deal_title),0,100); ?></a></h2>
                                                </div>
                                        </div> 
                                    </li>
                                 <?php } } ?>     
                    ...
                    <div class="slider_wrap">
                        ...
                        <?php  foreach( $this->get_sold_auction as $d){
                            ...
                            <li>
                                ...
                                $size = getimagesize($image_url);
                                            ?>
                                                                <a href="<?php echo PATH.'auction/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>">
                                                                 <?php if(($size[0] > 173) && ($size[1] > 252)) { ?>
<img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$d->deal_key.'_1'.'.png'?>&w=173&h=252" alt="<?php echo $d->deal_title; ?>" title="<?php echo $d->deal_title; ?>" border="0" />
                                ...
                                <?php } ?>
                                                                ...
                                                                <?php } else { ?>
                                                                <a href="<?php echo PATH.'auction/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>"><img src="<?php echo PATH.'resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&w=173&h=252"  alt="<?php echo $d->deal_title; ?>" title="<?php echo $d->deal_title; ?>" border="0" /></a>
                                                                <?php }?> 
                                       <a class="sold_out_bt"><?php echo $this->Lang['SOLD_OUT2']; ?></a>
                                    </div>
                                    <div class="product_listing_detail">
                                        <h2><a href="<?php echo PATH.'auction/'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $d->deal_title; ?>"><?php echo substr(ucfirst($d->deal_title),0,100); ?></a></h2>
                                    </div>
                                </div> 
                            </li>
                            <?php }?> 
