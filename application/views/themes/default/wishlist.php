						...
						<div class="show_wishlist_title">							                                                
							...
							<?php if($this->user_wishlist_count && count($this->user_wishlist_count) > 0) { ?>
								...
								<tr>
                                                                    ...
                                                                    <td>
                                                                            <a href="<?php echo PATH.'product/'.$products->deal_key.'/'.$products->url_title.'.html';?>" title="<?php echo $products->deal_title; ?>" style="color:#ff9b02;"><?php echo $products->deal_title; ?></a>
                                                                    </td>
                                                                    <?php
