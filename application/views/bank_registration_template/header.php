...
<?php  if(($this->uri=="merchant-login.html")||($this->uri=="admin-login.html")|| ($this->uri=="articles.html")||($this->uri=="merchant/forgot-password.html")){  }else { ?>
...
<?php } } else { ?>
<?php  if(($this->uri=="merchant-login.html")|| ($this->uri=="articles.html")|| ($this->uri=="admin-login.html")||($this->uri=="merchant/forgot-password.html")){  }else { ?>
<div class="dash_main_menu"> 
<ul>
