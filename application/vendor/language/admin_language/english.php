...
$content_text = array(
			...
			"COPYRIGHTS" => "©2013 $THIS_SITENAME All rights reserved",
			...
			"SHIP_DEL" => "Shipping And Delivery",
			...
			"MER_EMAIL_EXIT" => "Merchant Email Does Not Exisits",
			...
			"FREE_SHIPP_PROD" => "Free Shipping on this product",
                        ...
                        "PRODUCT_IMAGES_MUST" => "Maximum Upload image size 1024 x 1024,
                        Maximum 2 MB per image,
                        Allowed format: jpeg, gif,jpg or png",
