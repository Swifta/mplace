...
<div class="menu">
  <div class="menu_container">
	...
	<?php } ?>
	<?php   if(isset($this->products_act)){ ?>
	...
	<?php } ?>
	<?php  if(isset($this->merchant_act)){ ?>
	...
	<?php } ?>
	<?php if(isset($this->deals_act)||isset($this->products_act)|| isset($this->auction_act) ||isset($this->users_act)||isset($this->merchant_act)||isset($this->transactions_act)||isset($this->blog_act)){ }else {?>
...
<li <?php if(isset($this->archive_deals)){ ?> class="menu_active"  <?php } ?>>
  ...
  <!-- Import products End  -->
	...
	<li>
      ...
      <li onclick="toggle(20)" <?php if(isset($this->deal_cod_trans)){ ?> class="menu_active"  <?php } ?> >
	...
	<!-- FAQ END-->	
	<!--NEWS LETTER STARTS-->
      <li onclick="toggle(18)" <?php if(isset($this->news_letter)){ ?> class="menu_active"  <?php } ?> >
        ...
        <ul class="toggleul_18">
          <li>
             ...
             <a href="<?php echo PATH; ?>admin/send-newsletter.html" class="menu_rgt1" title="<?php echo $this->Lang['SEND_NEWSL']; ?>"><span class="news_letter"><?php echo $this->Lang["SEND_NEWSL"]; ?></span></a></li>
          <?php /* <li>
