...
<?php foreach($this->rss_deals_list as $Deals){?>
    <item>
	<link><?php echo PATH.'deals/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?></link>
	<title><?php  echo str_replace("&",'&#38;',$Deals->deal_title); ?></title>
	<pubDate><?php echo date(DATE_RFC3339, $Deals->created_date);?></pubDate>
    	<description>&lt;div&gt;&lt;a href="<?php echo PATH.'deals/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?>"&gt;&lt;img border="0" src="<?php echo PATH."images/deals/1000_800/".$Deals->deal_key."_1.png";?>" /&gt;&lt;/a&gt;&lt;/div&gt;
...
<?php foreach($this->rss_products_list as $Deals){?>
    <item>
	<link><?php echo PATH.'product/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?></link>
	<title><?php  echo str_replace("&",'&#38;',$Deals->deal_title); ?></title>
	<pubDate><?php echo date(DATE_RFC3339, $Deals->created_date);?></pubDate>
    	<description>&lt;div&gt;&lt;a href="<?php echo PATH.'product/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?>"&gt;&lt;img border="0" src="<?php echo PATH."images/products/1000_800/".$Deals->deal_key."_1.png";?>" /&gt;&lt;/a&gt;&lt;/div&gt;
    &lt;div&gt;&lt;p/&gt;  <?php echo str_replace(array("&", '"','[.]'),'', strip_tags($Deals->deal_description)); ?>&lt;/p&gt;&lt;/div&gt;
  	 </description>
	<category><?php echo str_replace("&", "&amp;", $Deals->category_name); ?></category>
	<price><?php echo $Deals->deal_value; ?></price>
...
<?php foreach($this->rss_auction_list as $Deals){?>
    <item>
	<link><?php echo PATH.'auction/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?></link>
	<title><?php  echo str_replace("&",'&#38;',$Deals->deal_title); ?></title>
	<pubDate><?php echo date(DATE_RFC3339, $Deals->created_date);?></pubDate>
    	<description>&lt;div&gt;&lt;a href="<?php echo PATH.'auction/'.$Deals->deal_key.'/'.$Deals->url_title.'.html';?>"&gt;&lt;img border="0" src="<?php echo PATH."images/auction/1000_800/".$Deals->deal_key."_1.png";?>" /&gt;&lt;/a&gt;&lt;/div&gt;
    &lt;div&gt;&lt;p/&gt;  <?php echo str_replace(array("&", '"','[.]'),'', strip_tags($Deals->deal_description)); ?>&lt;/p&gt;&lt;/div&gt;
  	 </description>
	<category><?php echo str_replace("&", "&amp;", $Deals->category_name); ?></category>
	<price><?php echo $Deals->deal_value; ?></price>
...
<feed  xml:lang="en-US"  xmlns="http://www.w3.org/2005/Atom">
  ...
  <entry>
    ...
    <updated><?php echo date(DATE_RFC3339, time()); ?></updated>
    <link type="text/html" rel="alternate" href="<?php echo PATH."../../application - Copy/views/deal".$Deals->deal_id."/".$Deals->deal_key;?>"/>
