                                                            ...
                                                            <?php if ($this->city_id) { ?> 
                                                                <?php foreach ($this->all_city_list as $CX) {
                                                                    if ($this->city_id == $CX->city_id) { ?>
                                                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/deals/rss' . $this->city_id . '/' . $CX->city_url; ?>" title="Rss"><img src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/new/rss1_2.png"  border="0" alt="Rss"/></a>
            <?php }
        }
    } ?>
                                                        </td>
