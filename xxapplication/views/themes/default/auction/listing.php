	...
	<div class="product_listing_image auction_listing_image wloader_parent">
            <i class="wloader_img">&nbsp;</i>
				...
				<?php if($this->session->get('cate')!="") { ?> <?php $url=$this->session->get('cate'); ?> <?php } else { ?> <?php $url=$deals->category_url; ?>  <?php } ?>
					...
					?>
						<a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo $deals->deal_title; ?>">
						 <?php if(($size[0] > AUCTION_LIST_WIDTH) && ($size[1] > AUCTION_LIST_HEIGHT)) { ?>
							<img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$deals->deal_key.'_1'.'.png'?>&amp;w=<?php echo AUCTION_LIST_WIDTH; ?>&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" border="0" />
							   <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800'.$deals->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
...
<!--				<div class="normal_view">
			...
			<div class="product_listing_detail">
				<h2><?php $type = ""; $categories = $deals->category_url; ?>
						<a class="cursor" href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo $deals->deal_title;?>"><?php echo substr(ucfirst($deals->deal_title),0,100);?></a>
				</h2>
			...
			<?php } ?>
				...
				<div class="deal_list_time">
					...
					<label><span time="<?php echo $deals->enddate; ?>" class="kkcount-down"></span></label>
                                ...
                                <a class="buy_it list_buy_it bid_it" href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo $this->Lang['BID_NOW1']; ?>"><?php echo $this->Lang['BID_NOW1']; ?></a>
