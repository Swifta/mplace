    ...
    <?php for ($i = 1; $i <= 5; $i++) { ?>
        <?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png')) { ?>
                                ...
                                $size = getimagesize($image_url);  ?>
                                    ...
                                    <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" class="MagicZoomPlus" id="Zoomer3" rel="zoom-position: inner; selectors-change: mouseover; selectors-mouseover-delay:70; selectors-effect: fade" title="">
                                    <?php if(($size[0] > AUCTION_DETAIL_WIDTH) && ($size[1] > AUCTION_DETAIL_HEIGHT)) { ?>
                                        <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/resize.php'; ?>?src=<?php echo PATH . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo AUCTION_DETAIL_WIDTH; ?>" />
                                        <?php } else { ?>
                                          <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800' . $deals->deal_key . '_' . $i . '.png' ?>" />
                                        <?php } ?>
        ...
        <?php } ?>
								...
								<span <?php if($k>3){ ?>class="MagicScroll" id="ZoomScroll" <?php } ?>>
									...
									?>
									<?php if(($size[0] > AUCTION_DETAIL_WIDTH) && ($size[1] > AUCTION_DETAIL_HEIGHT)) { ?>
										<a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png'; ?>&w=<?php echo AUCTION_DETAIL_WIDTH; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/resize.php'; ?>?src=<?php echo PATH . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo AUCTION_THUMB_WIDTH; ?>&amp;h=<?php echo AUCTION_THUMB_HEIGHT; ?>" />
                <?php /* <img src="<?php echo PATH.'images/auction/100_100/'.$products->deal_key.'_'.$i.'.png';?>"/> */ ?></a>
                
                                                                        <?php } else { ?>
                                                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png'; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/resize.php'; ?>?src=<?php echo PATH . 'images/auction/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo AUCTION_THUMB_WIDTH; ?>&amp;h=<?php echo AUCTION_THUMB_HEIGHT; ?>" /></a>
                                                                        <?php } ?>
										<?php } } ?>
									<?php } ?>
								</span>
    ...
    ?>
        ...
        ?>
                                ...
                                <p><?php echo $this->Lang['AUC_TYPE']; ?></p><span><?php echo $this->Lang['RESE_AUC']; ?></span>
                                        ...
                                        <a class="basic<?php echo $deals->deal_id; ?>" id="<?php echo $this->avg_rating; ?>" title="<?php echo $this->avg_rating; ?> / 5" > </a>
                                        </div>
                                        </div>
                                    </li>
                                        <div class="social_share">
                                        <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo PATH . 'auction/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?> &amp;layout=button_count&amp;show_faces=true&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden;  height:21px; width:82px;" allowTransparency="true"></iframe>
                                       ...
                                       <script type="text/javascript" src="https://apis.google.com/js/plusone.js">
                                            ...
                                            <div class="g-plusone" data-size="medium" data-href="<?php echo PATH . 'auction/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>"></div>
                    ...
                    <div class="deal_address">                                                                                                                       
                                ...
                                <h3><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/stores' . $deals->store_key . '/' . $deals->store_url_title . '.html'; ?>" title="<?php echo $deals->store_name; ?>"><?php echo $deals->store_name; ?></a></h3>
                                      ...
                                      <?php } */ ?>
                                            ...
                                            <div class="fbok_comment_block">                                                                                                                      
                                                ...
                                                <div class="fbok_comment wloader_parent">
                                                    ...
                                                    <div width="370" class="fb-comments" data-href="<?php echo PATH . 'auction/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" data-num-posts="10" ></div>
                                                </div>                                                                      
                                                </div>
       ...
       <?php if (count($this->all_deals_list) > 0) { ?>
            ...
            <div class="deal_list_slide clearfix">                
                <div id="welcomeHero" >
					...
					<a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/auction' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
<img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH.'images/auction/1000_800/'.$deals1->deal_key.'_1'.'.png';?>&amp;w=<?php echo AUCTION_LIST_WIDTH; ?>&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />
<?php /*<img src="<?php echo PATH . 'images/auction/220_160/' . $deals1->deal_key . '_1' . '.png'; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />*/ ?></a>
                                        <?php } else { ?>
                                            <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH . 'auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>&amp;w=<?php echo AUCTION_DETAIL_WIDTH; ?>&amp;h=<?php echo AUCTION_DETAIL_HEIGHT; ?>" title="<?php echo $deals1->deal_title; ?>">
                                                <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_auctions_list.png&amp;w=<?php echo AUCTION_LIST_WIDTH; ?>&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />
                                            </a>
                                        <?php } ?>                                                                               
                                <?php $url = PATH . 'auction/' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>                                                
                                    </div>
                                    <div class="product_listing_detail">
                                        ...
                                        <a class="buy_it list_buy_it bid_it" href="" title="<?php echo $this->Lang['BID_NOW1']; ?>" onclick="redirect_url('<?php echo $url; ?>');"><?php echo $this->Lang['BID_NOW1']; ?></a> 
                                    </div>
                                </div>
                            </li>
                            <?php } ?>
