                    ...
                    <div class="content_auction_mid">
                        <div class="cont_auc_lft">
                            <?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $payment->deal_key . '_1' . '.png')) { ?>
                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/auction' . $payment->deal_key . '/' . $payment->url_title . '.html'; ?>" title="<?php echo $payment->deal_title; ?>"><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/resize.php'; ?>?src=<?php echo PATH . 'images/auction/1000_800/' . $payment->deal_key . '_1' . '.png'; ?>&amp;w=<?php echo DEAL_THUMB_WIDTH; ?>&amp;h=<?php echo DEAL_THUMB_HEIGHT; ?>"  alt="<?php echo $payment->deal_title; ?>" title="<?php echo $payment->deal_title; ?>" >&nbsp;</a>
                            <?php } else { ?>
