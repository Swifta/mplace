<?php defined('SYSPATH') OR die('No direct access allowed.'); ?>
    ...
    <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$deals->deal_key.'_1'.'.png'?>&amp;w=<?php echo AUCTION_LIST_WIDTH; ?>&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" />
    <?php } else { ?>
    ...
    <?php /* <img src="<?php echo PATH.'images/auction/220_160/'.$deals->deal_key.'_1'.'.png';?>" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" >*/ ?></a>
                                                                                    <?php } else { ?>
                                                                                    <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo $deals->deal_title; ?>">
    <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&amp;w=<?php echo AUCTION_LIST_WIDTH; ?>&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" />
    <?php /*<img src="<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" >*/ ?></a>
                                ...
                                <div class="product_listing_detail">
                                    ...
                                    <h2><a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$deals->deal_key.'/'.$deals->url_title.'.html';?>" title="<?php echo substr($deals->deal_title,0,40)."..";?>"><?php echo substr(ucfirst($deals->deal_title),0,100);?></a></h2>
                                    <div class="bid_cont">
                                        <div class="bid_value">
