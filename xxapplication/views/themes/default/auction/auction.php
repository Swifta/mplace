...
<div class="contianer_outer">
    ...
    <?php if (count($this->banner_details) > 0) {   ?>
              <?php if(count($this->banner_details) != 1) {   ?>
                                ...
                                <div class="slider_home">
                                    <div class="images wloader_parent">
                                        ...
                                        <a target="_blank" href="<?php echo $banner->redirect_url; ?>"  title = "<?php echo $banner->image_title; ?>">                                            
                                            <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH . 'images/banner_images/' . $banner->banner_id . '.png'; ?>&amp;w=<?php echo BANNER_WIDTH; ?>&amp;h=<?php echo BANNER_HEIGHT; ?>" alt="<?php echo $banner->image_title; ?>"></a>
                                        </div>
                                        <?php } ?>
                                    </div>
                                            <div class="controls">
                        ...
                        <div class="images">
                                <?php foreach ($this->banner_details as $banner) { ?>
                                    <a  target="_blank" href="<?php echo $banner->redirect_url; ?>" title = "<?php echo $banner->image_title; ?>"><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/images/banner_images' . $banner->banner_id . '.png'; ?>" alt="<?php echo $banner->image_title; ?>"></a>
                                 <?php } ?>
                         </div>
                      </div>
                   <?php } }  ?>
                             ...
                             <?php if (count($this->ads_details) > 0) { ?>
                                    <?php foreach ($this->ads_details as $ads) { ?>
            <?php if ($ads->ads_position == "hr" && $ads->page_position==4) {  ?>
                                  <div class="banner_right_add wloader_parent">
                                      <i class="wloader_img" style="min-height:250px;">&nbsp;</i>
                                    <a href<a h="<?php echo $ads->redirect_url; ?>" target="blank" title="<?php echo ucfirst($ads->ads_title); ?>"><img src="<?php echo PATH; ?>images/ad_image/<?php echo $ads->ads_id; ?>.png " /></a>
                                  </div>
                             ...
                             <?php
                                ...
                                <li>
                                    <div class="hot_product_image wloader_parent">
                                        ...
                                        <?php  if(file_exists(DOCROOT.'images/auction/1000_800/'.$h->deal_key.'_1'.'.png')){ 
                                          $image_url = PATH . 'images/auction/1000_800/' . $h->deal_key . '_1' . '.png';
                                $size = getimagesize($image_url);
                                        ?>
						<a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$h->deal_key.'/'.$h->url_title.'.html';?>" title="<?php echo $h->deal_title; ?>">
						 <?php if(($size[0] > 170) && ($size[1] > AUCTION_LIST_HEIGHT)) { ?>
							<img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$h->deal_key.'_1'.'.png'?>&amp;w=170&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>" title="<?php echo $h->deal_title; ?>" border="0" />
							<?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800'.$h->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
							<?php /* <img src="<?php echo PATH.'images/auction/220_160/'.$h->deal_key.'_1'.'.png'?>"  alt="<?php echo $h->deal_title; ?>" title="<?php echo $h->deal_title; ?>" border="0" />*/ ?> </a>
					<?php } else { ?>
						<a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/auction'.$h->deal_key.'/'.$h->url_title.'.html';?>" title="<?php echo $h->deal_title; ?>"><img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_auctions_list.png&amp;w=170&amp;h=<?php echo AUCTION_LIST_HEIGHT; ?>"  alt="<?php echo $h->deal_title; ?>" title="<?php echo $h->deal_title; ?>" border="0" /></a>
					<?php }?>
                                    </div>
                                    <div class="hot_ptoduct_details">
                                        <a class="cursor" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"><h2><?php echo substr(ucfirst($h->deal_title), 0, 100); ?></h2></a>
                                        <span>
                                        <b><?php echo $symbol . " " . $h->deal_value; ?></b>
                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"  class="more_details"></a>
                                        </span>
                                    </div>
                                </li>
                                <?php } ?>
...
<!--                <div id="welcomeHero" <?php if(count($this->view_auction_list) < 4){ ?> class="slider_right_big_border_auto" <?php } else { ?> class="slider_right_big_border" <?php } ?> >
			...
			<?php
					...
					<?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/auction/images/auction/1000_800'.$deals1->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
                                
					</a>
                                        <?php } else { ?>
                                            <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/auction' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
					<img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/auction/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" border="0" />
					</a>
                                        <?php } ?>
 <?php /*                                       <div class="normal_view">
                                            ...
                                            <!--<a href="" title="<?php echo $this->Lang['BID_NOW1']; ?>" onclick="redirect_url('<?php echo $url; ?>');"><?php echo $this->Lang['BID_NOW1']; ?></a>-->
...
<link rel="stylesheet" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/themes' . THEME_NAME . '/css/jquery-ui.css' ?>" />
<script src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/auction/themes' . THEME_NAME . '/js/jquery-ui.js' ?>"></script>
<script>
	$(function() {
		$( "#slider-range" ).slider({
			range: true,
