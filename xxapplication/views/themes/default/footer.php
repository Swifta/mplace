    ...
    <?php if ($this->cms_setting == 0) {
        ...
        <?php if($d->cms_title != "Help"){ ?>
                                <li> <a <?php if ($d->type == 3) { ?>href="<?php echo $d->cms_desc; ?>" <?php } else { ?> href="<?php echo PATH . $d->cms_url . '../../../../application - Copy/views/themes/default/.php' ?>" <?php } ?> title="<?php echo $d->cms_title; ?>"> <span class="aerro_right_common1"> <?php echo $d->cms_title; ?></span></a></li>
                        <?php } ?>
                    <?php }
                } ?>
               </ul>
                ...
                <div class="footer_coloumn_three footer_list">
                   <div class="cridit_cards"> <h3><?php echo $this->Lang['MERCHANT_ACC']; ?></h3>
                    <ul class="foot_merchant">
                         <li> <a  href="<?php echo PATH . '../../../../application - Copy/views/themes/default/merchant-login.html'; ?>" title="<?php  echo $this->Lang['MER_LOIN']; ?>"><?php echo $this->Lang['MER_LOIN']; ?></a></li>
                         <li>/ </li>
                    <li><a  href="<?php echo PATH . '../../../../application - Copy/views/themes/default/merchant-signup-step1.html'; ?>" title="<?php  echo $this->Lang['MER_REGI']; ?>"><?php echo $this->Lang['MER_REGI']; ?></a> </li>
                    </ul>
                </div>
     ...
     if ($this->city_id) { ?>
        <?php foreach ($this->all_city_list as $CX) {
            if ($this->city_id == $CX->city_id) { ?>
                                    <li><a class="rss_1" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals/rss' . $this->city_id . '/' . $CX->city_url; ?>" target="blank" title="<?php echo $this->Lang['RSS_FEED']; ?>"></a></li>
    ...
    <li><a class="rss_1" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/rss'; ?>" target="_blank" title="<?php echo $this->Lang['RSS_FEED']; ?>"></a></li>
