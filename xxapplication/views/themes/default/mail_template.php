                ...
                <td style="padding:15px;">
                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #e3e3e3;padding:10px;color:#666666;font:normal 13px/19px arial;">
                                    <tr>
                                        ...
                                        <?php if(isset($this->signup) || isset($this->forgot)) { ?>
			        ...
			        <?php } ?>
                                ...
                                <tr height="10">
                                    ...
                                    <tr>
                                        <td>
                                        <?php echo $this->Lang['EMAIL_F']; ?> : <a style=" font:normal 12px/25px arial; color:#ff9b02;" title="<?php if(isset($this->email)) { echo $this->email; } ?>" ><?php if(isset($this->email)) { echo $this->email; }  ?></a> 
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                        <?php if(isset($this->signup) || isset($this->forgot)|| isset($this->admin_signup)) { ?>
                                        <?php echo $this->Lang['YOUR_PASS']; ?> : <a style=" font:normal 12px/25px arial; color:#ff9b02;" ><?php if(isset($this->password)) { echo $this->password; } ?></a>
                                           <?php } else { ?>
