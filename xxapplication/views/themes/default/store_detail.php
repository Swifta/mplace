    ...
    <div class="contianer_inner">
        <div class="contianer">
                ...
                <div class="deal_content store_content">
                    <div class="store_image wloader_parent">
                        ...
                        <?php if (file_exists(DOCROOT . 'images/merchant/600_370/' . $store->merchant_id . '_' . $store->store_id . '.png')) { ?>
                            <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH . 'images/merchant/600_370/' . $store->merchant_id . '_' . $store->store_id . '.png' ?>&amp;w=<?php echo STORE_DETAIL_WIDTH; ?>&amp;h=<?php echo STORE_DETAIL_HEIGHT; ?>" alt="<?php echo $this->Lang['IMAGE']; ?>" />
                        <?php } else { ?>
                            <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_stores_details.png&amp;w=<?php echo STORE_DETAIL_WIDTH; ?>&amp;h=<?php echo STORE_DETAIL_HEIGHT; ?>"  alt="<?php echo $this->Lang['IMAGE']; ?>">
                        <?php } ?>
                    </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="product_listing">
                                                    <div class="product_listing_image wloader_parent">
                                                        ...
                                                        ?>
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $products->deal_title; ?>">
                                                            <?php if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
                                                                <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_1' . '.png' ?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $products->deal_title; ?>" title="<?php echo $products->deal_title; ?>" />
                                                                 <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/products/1000_800'.$products->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
                                                    ...
                                                    <div class="product_listing_detail">
                                                        ...
                                                        <h2><a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $products->deal_title; ?>"><?php echo substr(ucfirst($products->deal_title), 0, 100); ?></a></h2>
                                                        ...
                                                        <div class="product_view_detail">
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $this->Lang['ADD_TO_CART']; ?>"><?php /* echo $this->Lang['ADD_TO_CART']; */ ?></a>                                                                     
                                                        </div>
                                                    </div>
                                                </div> 
                                            </li>
                                    ...
                                    <ul  <?php if (count($this->get_deals_categories) > 4) { ?> id="mycarousel3" class="jcarousel-skin-tango2" <?php } else { ?> <?php } ?>>
                                        ...
                                        foreach ($this->get_deals_categories as $deals_categories) {
                                                ...
                                                <div class="product_listing">
                                                    ...
                                                    <div class="deal_listing_image wloader_parent">
                                                        ...
                                                        <?php if (file_exists(DOCROOT . 'images/deals/1000_800/' . $deals_categories->deal_key . '_1' . '.png')) {
                                                           ...
                                                           $size = getimagesize($image_url); ?>
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals' . $deals_categories->deal_key . '/' . $deals_categories->url_title . '.html'; ?>" >
                                                             <?php if(($size[0] > DEAL_LIST_WIDTH) && ($size[1] > DEAL_LIST_HEIGHT)) { ?>
                                                                <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals_categories->deal_key . '_1' . '.png'; ?>&amp;w=<?php echo DEAL_LIST_WIDTH; ?>&amp;h=<?php echo DEAL_LIST_HEIGHT; ?>" alt="<?php echo $this->Lang['IMAGE']; ?>" title="<?php echo $this->Lang['IMAGE']; ?>" />
                                                                <?php } else { ?>
                                                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/deals/1000_800'.$deals_categories->deal_key.'_1'.'.png'?>" />
                                                                <?php } ?>
                                            ...
                                            $categories = $deals_categories->category_url;
                                                        ?>
                                                            <a class="cursor" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals' . $deals_categories->deal_key . '/' . $deals_categories->url_title . '.html'; ?>" title="<?php echo substr(ucfirst($deals_categories->deal_title), 0, 25) . "..."; ?>"><?php echo substr(ucfirst($deals_categories->deal_title), 0, 100) ; ?></a>
                                                        </h2>                                                                    
            ...
            <?php /* <p><?php echo $symbol . " " . $deals_categories->deal_price; ?></p> */ ?>
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals' . $deals_categories->deal_key . '/' . $deals_categories->url_title . '.html'; ?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?></a>                                                                    
                                                    </div>
            ...
            <?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $deals1->deal_key . '_1' . '.png')) { 
               $image_url = PATH . 'images/auction/1000_800/' . $deals1->deal_key . '_1' . '.png';
                                $size = getimagesize($image_url);
                                ?>
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/auction' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
                                                                ...
                                                                <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/auction/1000_800'.$deals1->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
            ...
            ?>
                                                            <a class="cursor" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/auction' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>"><?php echo substr(ucfirst($deals1->deal_title), 0, 100); ?></a>
                                                        </h2>                                                                    
            ...
            <?php } ?>
                                                            ...
                                                            <a class="buy_it list_buy_it bid_it" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/auction' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $this->Lang['BID_NOW1']; ?>"><?php echo $this->Lang['BID_NOW1']; ?></a>                                                                    
...
<?php } ?>
                                                ...
                                                <div class="product_listing auction_listing branch_listing">                                                                                                                        
                                                    <div class="product_listing_image wloader_parent">      
                                                        ...
                                                        <?php if (file_exists(DOCROOT . 'images/merchant/290_215/' . $stores->merchant_id . '_' . $stores->store_id . '.png')) { ?>
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/stores' . $stores->store_key . '/' . $stores->store_url_title . '.html'; ?>" title="<?php echo $stores->store_name; ?>">
                                                                <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH . 'images/merchant/290_215/' . $stores->merchant_id . '_' . $stores->store_id . '.png' ?>&amp;w=150&amp;h=130" alt="<?php echo $stores->store_name; ?>" title="<?php echo $stores->store_name; ?>" />
        ...
        <?php } else { ?>
                                                            <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/stores' . $stores->store_key . '/' . $stores->store_url_title . '.html'; ?>" title="<?php echo $stores->store_name; ?>"><img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_stores_list.png&amp;w=150&amp;h=130"   alt="<?php echo $stores->store_name; ?>" title="<?php echo $stores->store_name; ?>" ></a>
        <?php } ?>                                                   
                                                    </div>
                                                    <div class="product_listing_detail">
                                                        <h2><a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/stores' . $stores->store_key . '/' . $stores->store_url_title . '.html'; ?>" title="<?php echo $stores->store_name; ?>"><?php echo substr(ucfirst($stores->store_name), 0, 100) ; ?></a></h2>
                                                        <!--<h3> <a title="<?php echo $stores->address1; ?>"><?php echo $stores->address1; ?></a></h3>-->                                                                                                                                                                                                                                                                                              
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/stores' . $stores->store_key . '/' . $stores->store_url_title . '.html'; ?>" title="<?php echo $this->Lang['VIEW_DETAILS']; ?>"><?php echo $this->Lang['VIEW_DETAILS']; ?></a>                                                                                                                                                    
                                                    </div>                                                                                                                        
                                                </div> 
                                            </li>
                                <?php } ?>   
