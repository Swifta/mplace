<div class="contianer_outer1">
    <div class="contianer_inner">
        ...
        <?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $u->deal_key . '_1' . '.png')) { ?>
                                            <a class="winner_list_deal_image" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/users/auction' . $u->deal_key . '/' . $u->url_title . '.html'; ?>" title="<?php echo $u->deal_title; ?>">
                                              <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/resize.php';?>?src=<?php echo PATH .'images/auction/1000_800/'.$u->deal_key.'_1'.'.png'?>&amp;w=100&amp;h=100" alt="<?php echo $this->Lang['IMAGE']; ?>" />
                                            </a>
        <?php } else { ?>
                                            <a class="winner_list_deal_image" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/users/auction' . $u->deal_key . '/' . $u->url_title . '.html'; ?>" title="<?php echo $this->Lang['IMAGE']; ?>">
                                               <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/resize.php';?>?src=<?php echo PATH;?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&amp;w=100&amp;h=100"  alt="<?php echo $this->Lang['IMAGE']; ?>" />
                                            </a>
        <?php } ?>
                                    </td>
                                    <td>
                                        <p><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/users/auction' . $u->deal_key . '/' . $u->url_title . '.html'; ?>" title="<?php echo $u->deal_title; ?>"><?php echo $u->deal_title; ?></a></p>
                                    </td>
