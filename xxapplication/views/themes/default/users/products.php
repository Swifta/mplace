...
<thead>
    ...
    <?php } ?>
		...
		<?php foreach($this->products_coupons_list as $p){ ?>
			 	<tr>
                                <td><a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/product'.$p->deal_key.'/'.$p->url_title.'.html';?>" title="<?php echo $p->deal_title;?>" class="fl clear"><?php echo $p->deal_title;?></a></td>
