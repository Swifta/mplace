					...
					<?php foreach($this->deals_coupons_list as $u){
					  ...
					  $start_time = strtotime($current_date);
				 	  ...
				 	  ?>
                                        ...
                                        <tr>
					    <td><a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/deals'.$u->deal_key.'/'.$u->url_title.'.html';?>" title="<?php echo $u->deal_title;?>" class="fl clear"><?php echo $u->deal_title;?></a></td>
					    <td><a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/stores'.$u->store_key.'/'.$u->store_url_title.'.html';?>" title="<?php echo $u->store_name; ?>"><?php echo $u->store_name; ?></a></td>
