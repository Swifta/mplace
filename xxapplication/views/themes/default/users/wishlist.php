							...
							foreach($wishlist_id as $p_id)
							{
								...
								<tr>
                                                                    <td>
                                                                        ...
                                                                        <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/product'.$products->deal_key.'/'.$products->url_title.'.html';?>" title="<?php echo $products->deal_title; ?>">
                                                                                <?php  if(file_exists(DOCROOT.'images/products/1000_800/'.$products->deal_key.'_1'.'.png')){ ?>
                                                                                        <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/resize.php';?>?src=<?php echo PATH.'/images/products/1000_800/'.$products->deal_key.'_1.png'?>&amp;w=80&amp;h=80"  alt="<?php echo $products->deal_title; ?>" title="<?php echo $products->deal_title; ?>">
                                                                                <?php } else { ?>
                                                                                        <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=80&amp;h=80" alt="<?php echo $products->deal_title; ?>" title="<?php echo $products->deal_title; ?>" />
                                                                                <?php }?>
                                                                        </a>
                                                                    ...
                                                                    <td>
                                                                            <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/product'.$products->deal_key.'/'.$products->url_title.'.html';?>" title="<?php echo $products->deal_title; ?>"><?php echo $products->deal_title; ?></a>
                                                                    </td>
                                                                    <?php
                                                                    ...
                                                                    <td>
                                                                            <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/users/product'.$products->deal_key.'/'.$products->url_title.'.html';?>" class="buy_it" title="<?php echo $this->Lang['ADD_TO_CART']; ?>"><?php echo $this->Lang['ADD_TO_CART']; ?></a>
                                                                   </td>
								</tr>
							                            <?php
								                  }
