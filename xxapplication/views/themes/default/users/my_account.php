                                                    ...
                                                    <div class="pi_detail">
                                                        <div class="pi_detail_info">
                                                            <?php if (file_exists(DOCROOT . 'images/user/150_115/' . $u->user_id . '.png')) {
                                                                ?>
                                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/users/images/user/150_115' . $u->user_id . '.png'; ?>"  />
                                                            <?php } elseif (file_exists(DOCROOT . 'images/user/150_115/' . $u->user_id . '.jpg')) { ?>
                                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/users/images/user/150_115' . $u->user_id . '.jpg'; ?>"  />
                                                            <?php } else { ?>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <div class="pi_detail">
                                                            ...
                                                            <div class="pi_detail_edit" style="color: #FF9B02;font: bold 13px arial;padding: 1px 17px;text-align: right;" id="city_ic">
...
$username  = ucfirst($parsedJson->name);
$gender = ucfirst($parsedJson->gender);
