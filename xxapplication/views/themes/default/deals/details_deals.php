    ...
    <?php for ($i = 1; $i <= 5; $i++) { ?>
        <?php if (file_exists(DOCROOT . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png')) { ?>
                                ...
                                $size = getimagesize($image_url);  ?>
                                    ...
                                    <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" class="MagicZoomPlus" id="Zoomer3" rel="zoom-position: inner; selectors-change: mouseover; selectors-mouseover-delay:70; selectors-effect: fade" title="">
                                    <?php if(($size[0] > DEAL_DETAIL_WIDTH) && ($size[1] > DEAL_DETAIL_HEIGHT)) { ?>
                                        <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo DEAL_DETAIL_WIDTH; ?>" />
                                        <?php } else { ?>
                                          <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800' . $deals->deal_key . '_' . $i . '.png' ?>" />
                                        <?php } ?>
        ...
        <?php if (($deals->maximum_deals_limit == $deals->purchase_count) || ($deals->maximum_deals_limit < $deals->purchase_count) || ($deals->enddate < time())) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a href="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_details.png" class="MagicZoomPlus" id="Zoomer3" rel="zoom-position: inner; selectors-change: mouseover; selectors-mouseover-delay:70; selectors-effect: fade" title=""><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_details.png&amp;w=<?php echo DEAL_DETAIL_WIDTH; ?>"/></a>
                                     <?php if (($deals->maximum_deals_limit == $deals->purchase_count) || ($deals->maximum_deals_limit < $deals->purchase_count) || ($deals->enddate < time())) { ?>
                                    <div class="should_out_images">
                                        &nbsp;
                                    </div>
								...
								<span <?php if($k>3){ ?>class="MagicScroll" id="ZoomScroll" <?php } ?>>
									...
									?>
									<?php if(($size[0] > DEAL_DETAIL_WIDTH) && ($size[1] > DEAL_DETAIL_HEIGHT)) { ?>
										<a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png'; ?>&w=<?php echo DEAL_DETAIL_WIDTH; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo DEAL_THUMB_WIDTH; ?>&amp;h=<?php echo DEAL_THUMB_HEIGHT; ?>" />
                <?php /* <img src="<?php echo PATH.'images/deals/100_100/'.$products->deal_key.'_'.$i.'.png';?>"/> */ ?></a>
                
                                                                        <?php } else { ?>
                                                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800' . $deals->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png'; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo DEAL_THUMB_WIDTH; ?>&amp;h=<?php echo DEAL_THUMB_HEIGHT; ?>" /></a>
                                                                        <?php } ?>
										<?php } } ?>
									<?php } ?>
								</span>
                        ...
                        <div class="deal_info">
                                ...
                                <div class="deal_rating">
                                   ...
                                   <span><?php echo $this->sum_rating; ?> <?php echo $this->Lang['RATINGS']; ?></span>
                                    ...
                                    <a class="buy_it_fr" <?php if (!$this->UserID) { ?>href="javascript:showlogin('<?php if (isset($this->UserID)) {
                                        echo $this->UserID;
                                    } ?>','<?php echo $this->uri->segment(1); ?>','<?php echo $deals->deal_key; ?>','<?php echo $deals->url_title; ?>');" <?php } else { ?> href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deal/payment_details_friend' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" <?php } ?>	 title="Send to a friend"><?php echo $this->Lang['SE_A_FR']; ?></a>
                                <?php } ?>
                            </div>
                            ...
                            <div class="deal_share clearfix">
                                <div class="social_share">
                                    <div class="social_share">
                                        <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?> &amp;layout=button_count&amp;show_faces=true&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden;  height:21px; width:82px;" allowTransparency="true"></iframe>
                                            <script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
                                            <a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" data-count="horizontal"><?php echo $this->Lang['TWEET']; ?></a>
    ...
    <?php if (($deals->maximum_deals_limit == $deals->purchase_count) || ($deals->maximum_deals_limit < $deals->purchase_count) || ($deals->enddate < time())) { ?>
                        ...
                        <?php } else { ?>
                         <script type="text/javascript">
                                    ...
                                    <a class="buy_it" id="auction" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals_payment/p' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?> </a>
                    ...
                    <div class="deal_comment_block">
                        <div class="deal_address">
                            ...
                            <address class="deal_map_address">
                                 <h3><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/stores' . $deals->store_key . '/' . $deals->store_url_title . '.html'; ?>" title="<?php echo $deals->store_name; ?>"><?php echo $deals->store_name; ?></a></h3>
                         ...
                         */ ?>
                            <div class="fbok_comment_block">
                                ...
                                <div class="fbok_comment wloader_parent">
                                    ...
                                    <div width="370" class="fb-comments" data-href="<?php echo PATH . 'deals/' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" data-num-posts="10" ></div>
                                </div>
                            </div>
                        </div>
        ...
        <?php /* <p> <?php echo $this->Lang['FEAT_DEALS']; ?></p> */ ?>
                                                ...
                                                <li>
                                                    <div class="product_listing">
                                                        <div class="deal_listing_image wloader_parent">
                                                            <i class="wloader_img">&nbsp;</i>
                                                            <div class="deal_ribbon">
                                                                <p>OFF</p>
                                                                <b><?php echo round($deals1->deal_percentage); ?>%</b>
                                                            </div>
                ...
                <?php if (file_exists(DOCROOT . 'images/deals/1000_800/' . $deals1->deal_key . '_1' . '.png')) { 
                 $image_url = PATH . 'images/deals/1000_800/' . $deals1->deal_key . '_1' . '.png';
                                $size = getimagesize($image_url);
                ?>
                                                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>">
                                                                 <?php if(($size[0] > DEAL_LIST_WIDTH) && ($size[1] > DEAL_LIST_HEIGHT)) { ?>
                                                                    <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals1->deal_key . '_1' . '.png' ?>&amp;w=<?php echo DEAL_LIST_WIDTH; ?>&amp;h=<?php echo DEAL_LIST_HEIGHT; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" >
                                                                    <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800'.$deals1->deal_key.'_1'.'.png'?>" />
                                <?php } ?>

                                                                </a>
                <?php } else { ?>
                                                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $deals1->deal_title; ?>"><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_deals_list.png&amp;w=<?php echo DEAL_LIST_WIDTH; ?>&amp;h=<?php echo DEAL_LIST_HEIGHT; ?>"  alt="<?php echo $deals1->deal_title; ?>" title="<?php echo $deals1->deal_title; ?>" ></a>
                                                                <?php } ?>
                                                        </div>
                ...
                ?>
                                                                <a class="cursor" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>"><?php echo substr(ucfirst($deals1->deal_title), 0, 100); ?></a>
                                                            </h2>
                ...
                <?php /* <p><?php //echo $symbol . " " . $deals->deal_price; ?></p> */ ?>
                                                                <p><?php echo $symbol . " " . $deals1->deal_value; ?></p>
                                                            </div>											
                                                            <a class="buy_it list_buy_it" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals1->deal_key . '/' . $deals1->url_title . '.html'; ?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </li>
