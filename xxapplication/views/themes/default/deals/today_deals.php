...
<div class="contianer_outer">
        ...
        <?php if (count($this->all_deals_list) > 0) { ?>
            ...
            <?php foreach ($this->banner_details as $banner) { ?>                                            
                                                <div style="display: block;">                                                                                                        
                                                    <a target="_blank" href="<?php echo $banner->redirect_url; ?>" title = "<?php echo $banner->image_title; ?>">                                                       
                                                        <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/banner_images' . $banner->banner_id . '.png'; ?>" alt="<?php echo $banner->image_title; ?>"></a>
                                                </div>
            <?php } ?>
                                        </div>
                                        <div class="controls">
            ...
            <?php } ?>
                                ...
                                <div class="banner">
                                    <div class="images">
                                        <?php foreach ($this->banner_details as $banner) { ?>
                                            <a  target="_blank" href="<?php echo $banner->redirect_url; ?>" title = "<?php echo $banner->image_title; ?>" ><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/images/banner_images' . $banner->banner_id . '.png'; ?>" alt="<?php echo $banner->image_title; ?>"></a>
                                <?php } ?>
                                    </div>
                                </div>
                            <?php }
    ...
    <?php if (count($this->ads_details) > 0) { ?>
        <?php foreach ($this->ads_details as $ads) { ?>
            <?php if ($ads->ads_position == "hr" && $ads->page_position == 2) { ?>
                                    <div class="banner_right_add wloader_parent">
                                     ...
                                     <a href="<?php echo $ads->redirect_url; ?>" target="blank" title="<?php echo ucfirst($ads->ads_title); ?>"><img src="<?php echo PATH; ?>images/ad_image/<?php echo $ads->ads_id; ?>.png " /></a> 
                                          ...
                                          <?php /*   <iframe src='http://www.flipkart.com/affiliate/displayWidget?affrid=WRID-138279733927085502' frameborder=0 height=250 width=300></iframe> */ ?>
                                    </div>
                            ...
                            <ul>
                             <?php
                                ...
                                $size = getimagesize($image_url);
                                        ?>
                                                    <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>">
                                                    <?php if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
                                                         <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/deals/resize.php';?>?src=<?php echo PATH .'images/deals/1000_800/'.$h->deal_key.'_1'.'.png'?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>"   border="0" />
                                                         <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800'.$h->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
                                                     </a>
                                                <?php } else { ?>
                                                    <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>">
                                                        <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/deals/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>" /></a>
            <?php } ?>
                                    ...
                                    <div class="hot_ptoduct_details">
                                        <a class="cursor" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"><h2><?php echo substr(ucfirst($h->deal_title), 0, 100); ?></h2></a>
                                        <span>
                                        <b><?php echo $symbol . " " . $h->deal_value; ?></b>
                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"  class="more_details"></a>
                                        </span>
                                    </div>
                                </li>
                                <?php } ?>
...
<?php if (count($this->view_deals_list) > 0) { ?>
                ...
                <?php if ($this->session->get('cate') != "") { ?> <?php $url = $this->session->get('cate'); ?> <?php } else { ?> <?php $url = $deals->category_url; ?>  <?php } ?>
                                                            ...
                                                            $image_url = PATH . 'images/deals/1000_800/' . $deals->deal_key . '_1' . '.png';
                                                                $size2 = getimagesize($image_url);
                                                            ?>
                                                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>">
                                                                <?php if(($size2[0] > 168) && ($size2[1] > 180)) { ?>
                                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH . 'images/deals/1000_800/' . $deals->deal_key . '_1' . '.png' ?>&amp;w=168&amp;h=180" alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" />
                                                             <?php } else { ?>
                                                                <img src="<?php echo PATH .'../../../../../application - Copy/views/themes/default/deals/images/deals/1000_800'.$deals->deal_key.'_1'.'.png'?>" />
                                                                <?php } ?>   
                                                                </a>
                                                        <?php } else { ?>
                                                            <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $deals->deal_title; ?>"><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/resize.php'; ?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=168&amp;h=180"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" ></a>
                                                        <?php } ?>   
...
<!--                                                                <p><?php //echo $symbol . " " . $deals->deal_price; ?></p>-->
                                                                <b><?php echo $symbol . " " . $deals->deal_value; ?></b>
                                                            </div>
...
<link rel="stylesheet" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/themes' . THEME_NAME . '/css/jquery-ui.css' ?>" />
<script src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/themes' . THEME_NAME . '/js/jquery-ui.js' ?>"></script>
<script>
    $(function() {
        $("#slider-range").slider({
            range: true,
