...
if (($deals->maximum_deals_limit == $deals->purchase_count) || ($deals->maximum_deals_limit < $deals->purchase_count) || ($deals->enddate < time())) {  } else {
		...
		<?php if($this->session->get('cate')!="") { ?> <?php $url=$this->session->get('cate'); ?> <?php } else { ?> <?php $url=$deals->category_url; ?>  <?php } ?>
                    ...
                    ?>
                        ...
                        <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/deals/resize.php';?>?src=<?php echo PATH .'images/deals/1000_800/'.$deals->deal_key.'_1'.'.png'?>&amp;w=<?php echo DEAL_LIST_WIDTH; ?>&amp;h=<?php echo DEAL_LIST_HEIGHT; ?>"  alt="<?php echo $deals->deal_title; ?>" title="<?php echo $deals->deal_title; ?>" > 
                        <?php } else { ?>
        ...
        <?php } ?>
			...
			<a class="cursor" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>"><?php echo substr(ucfirst($deals->deal_title),0,100); ?></a>
			</h2>
...
<!--<p><?php //echo $symbol . " " . $deals->deal_price; ?></p>   -->
                ...
                <a class="buy_it list_buy_it" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/deals/deals' . $deals->deal_key . '/' . $deals->url_title . '.html'; ?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>"><?php echo $this->Lang['BUY_NOW2']; ?></a>                                                    
                </div>
        </div>
        <?php if(($i%4) == 0){ ?>
