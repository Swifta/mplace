								...
								<?php } ?>
									...
									<?php foreach($this->deals_list as $deals){ ?>
										<?php if (($this->type==1)||($this->type=='')) { ?>
											...
											$dealUrl = PATH."deals/".$deals->deal_key."/".$deals->url_title.".html"; 
...
<img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/deals/resize.php';?>?src=<?php echo $imgpath; ?>&amp;w=<?php echo MAP_LIST_WIDTH; ?>&amp;h=<?php echo MAP_LIST_HEIGHT; ?>"  alt="<?php echo $this->Lang['DEAL_IMG']; ?>"/>
											</a>
										</div>
