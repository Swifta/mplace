				...
				<div class="menu_left">
					<ul>
						...
						foreach ($this->get_all_cms_title as $d) {
							...
							?>
							<li> <a class="aerrnone" <?php if ($d->type == 3) { ?>href="<?php echo $d->cms_desc; ?>" <?php } else { ?> href="<?php echo PATH . $d->cms_url . '../../../../application - Copy/views/themes/default/.php' ?>" <?php } ?> title="<?php echo $cms_title; ?>"> <span class="aerro_right_common1"> <?php echo $cms_title; ?></span></a></li>
...
<div class='popup_block3'><?php echo new View("themes/" . THEME_NAME . '/users/sign_up_popup'); ?></div>
