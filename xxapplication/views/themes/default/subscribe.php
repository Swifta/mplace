<script src="<?php echo PATH.'../../../../application - Copy/views/themes/default/themes'.THEME_NAME.'/js/jquery.validate.js' ?>"></script>
                    ...
                    <div class="category_sidebar">                        
                            ...
                            <ul class="cate_menu">
                                ...
                                <?php foreach ($this->category_list as $d) {
									...
									if ($d->product == 1 && isset($this->is_product) && ($check_sub_cat !=-1)) {
                                        ?> 
