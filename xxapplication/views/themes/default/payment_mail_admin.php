                        ...
                        <tr>
                            <td>
                                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #e3e3e3;padding:10px;color:#666666;font:normal 13px/19px arial;">
                                    ...
                                    <tr>
                                        <td style="font:normal 16px/18px arial;color:#000;"><?php echo $this->Lang['MERCHANT_NAME']; ?>: <b style="color:#ff9b02;"><?php echo $merchant_firstneme; ?> <?php echo $merchant_lastname; ?></b></td> 
                                    </tr>
                                    <tr height="10">
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td style="font:normal 16px/18px arial;color:#000;"><?php echo $this->Lang['MERCHANT_EMAIL']; ?>: <b style="color:#ff9b02;"><?php echo $merchant_email; ?></b></td>
                                    </tr>                                    
                                    <tr height="25">
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="font:normal 16px/18px arial;color:#000;"><?php echo $this->Lang['BUYERS_NAME']; ?>: <b style="color:#ff9b02;"><?php echo $this->UserName; ?></b></td> 
                                    </tr>
                                    <tr height="10">
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td style="font:normal 16px/18px arial;color:#000;"><?php echo $this->Lang['BUYERS_EMAIL']; ?>: <b style="color:#ff9b02;"><?php echo $this->UserEmail; ?></b></td>
                                    </tr>                                    
                                    <tr height="25">
                                        <td></td>
                                    </tr>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tfoot style="border-top:1px solid #ece9e4;font:normal 15px arial;color:#000;">
                                                    <tr>
                                                        ...
                                                        <td align="right" style="color:#ff9b02;"><?php echo CURRENCY_SYMBOL.$R->total; ?></td>
                                                    </tr>
                                                    <tr height="10"><td></td></tr>
                                                    <tr>
                                                        <td colspan="4" align="right"><?php echo $this->Lang["REF_AMM"]; ?></td>
                                                        <td align="center" style="font-size: 13px; color:#666;">=</td>
                                                        <td align="right" style="color:#ff9b02;"><?php echo CURRENCY_SYMBOL.$R->ref_amount; ?></td>
                                                    </tr>
                                                    <tr height="10"><td></td></tr>
                                                    <tr>
                                                        <td colspan="4" align="right"><?php echo $this->Lang["USER_CREDIT_AMOUNT"]; ?></td>
                                                        <td align="center" style="font-size: 13px; color:#666;">=</td>
                                                        <td align="right" style="color:#ff9b02;"><?php echo CURRENCY_SYMBOL.$R->amount; ?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>                                            
                                        </td>
