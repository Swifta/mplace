                ...
                <?php if(count($this->banner_details) != 1) {   ?>                         
					...
					<?php foreach ($this->banner_details as $banner) { ?>                                        
                                    ...
                                    <a target="_blank" href="<?php echo $banner->redirect_url; ?>"  title = "<?php echo $banner->image_title; ?>">
                                        <img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/images/banner_images' . $banner->banner_id . '.png'; ?>" alt="<?php echo $banner->image_title; ?>">
                                    </a>
                                    </div>
                                 <?php } ?>      </div>                             
                                            <div class="controls">
                        ...
                        <i class="wloader_img" style="min-height: 248px;">&nbsp;</i>  
                                <?php foreach ($this->banner_details as $banner) { ?>
                                                                        <a  target="_blank" href="<?php echo $banner->redirect_url; ?>" title = "<?php echo $banner->image_title; ?>" ><img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/images/banner_images' . $banner->banner_id . '.png'; ?>" alt="<?php echo $banner->image_title; ?>"></a>
                                                                     <?php } ?>  
                         </div>                        						
                        ...
                        <div class="hot_prodocuts">
                            <ul>
                                ...
                                $size = getimagesize($image_url);
                                        ?>
                                                    <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>">
                                                     <?php if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
                                                         <img src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH .'images/products/1000_800/'.$h->deal_key.'_1'.'.png'?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>"   border="0" />
                                                         <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/products/1000_800'.$h->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
                                                     </a>
                                                <?php } else { ?>
                                                    <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>">
                                                        <img src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $h->deal_title; ?>" /></a>
            <?php } ?>
                                        <div class="hot_label">
                                            <p>OFF</p>
                                    ...
                                    <div class="hot_ptoduct_details">
                                        <a class="cursor" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"><h2><?php echo substr(ucfirst($h->deal_title), 0, 100); ?></h2></a>
                                        <span>
                                        <b><?php echo $symbol . " " . $h->deal_value; ?></b>
                                        <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $h->deal_key . '/' . $h->url_title . '.html'; ?>" title="<?php echo $h->deal_title; ?>"  class="more_details"></a>
                                        </span>                                        
                                    </div>
                                </li>
                                <?php } ?>
...
<a class="view_more" onclick="filtercategory('<?php echo $categories; ?>', '<?php echo $type; ?>', '<?php echo base64_encode("main"); ?>');" title="<?php echo $this->Lang['SEE_MO']; ?>"><?php echo $this->Lang['SEE_MO']; ?></a><?php } ?>
            ...
            <?php if (file_exists(DOCROOT . 'images/products/1000_800/' . $p->deal_key . '_1' . '.png')) { 
             $image_url = PATH . 'images/products/1000_800/' . $p->deal_key . '_1' . '.png';
                                $size = getimagesize($image_url);
            ?>
                                                    <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $p->deal_key . '/' . $p->url_title . '.html'; ?>" title="<?php echo $p->deal_title; ?>">
                                                    <?php if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
                                                         <img src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH .'images/products/1000_800/'.$p->deal_key.'_1'.'.png'?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $p->deal_title; ?>"   border="0" />
                                                         <?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/products/1000_800'.$p->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
...
*/ ?></a>
                                                <?php } else { ?>
                                                    <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $p->deal_key . '/' . $p->url_title . '.html'; ?>" title="<?php echo $p->deal_title; ?>">
                                                        <img src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $p->deal_title; ?>" /></a>
            <?php } ?>
                                            ...
                                            <div class="product_listing_detail">
                                                ...
                                                <h2><a class="cursor" href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $p->deal_key . '/' . $p->url_title . '.html'; ?>" title="<?php echo $p->deal_title; ?>"><?php echo substr(ucfirst($p->deal_title), 0, 100) ; ?></a></h2>
...
<!--                                                <p><?php //echo $symbol . " " . $p->deal_price; ?></p>   -->
                                                ...
                                                <div class="product_view_detail">                                               
                                                                <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/product' . $p->deal_key . '/' . $p->url_title . '.html'; ?>" title="<?php echo $this->Lang['ADD_TO_CART']; ?>"></a>
                                                </div>
                                            </div>
                                        </div>
                                 <?php } ?>
...
?>
					...
					<?php } else { ?>												
                                ...
                                $size = getimagesize($image_url);
                                         ?>
                                        <a   href="<?php echo PATH.'../../../../application - Copy/views/themes/default/product'.$products_list->deal_key.'/'.$products_list->url_title.'.html';?>" title="<?php echo $products_list->deal_title; ?>" >
                                        <?php if(($size[0] > PRODUCT_LIST_WIDTH) && ($size[1] > PRODUCT_LIST_HEIGHT)) { ?>
											<img src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH .'images/products/1000_800/'.$products_list->deal_key.'_1'.'.png'?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $products_list->deal_title; ?>" title="<?php echo $products_list->deal_title; ?>" />
											
											<?php } else { ?>
                                 <img src="<?php echo PATH .'../../../../application - Copy/views/themes/default/images/products/1000_800'.$products_list->deal_key.'_1'.'.png'?>" />
                                <?php } ?>
                                        ...
                                        <a  href="<?php echo PATH.'../../../../application - Copy/views/themes/default/product'.$products_list->deal_key.'/'.$products_list->url_title.'.html';?>" title="<?php echo $products_list->deal_title; ?>">
                                            <img title=" " alt="" src="<?php echo PATH.'../../../../application - Copy/views/themes/default/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" >
                                        </a>
                                         <?php }?>
                                    ...
                                    <div class="side_porduct_detail">
                                        <h2>
                                            <a class="cursor"  href="<?php echo PATH.'../../../../application - Copy/views/themes/default/product'.$products_list->deal_key.'/'.$products_list->url_title.'.html';?>" title="<?php echo $products_list->deal_title;?>"><?php echo substr(ucfirst($products_list->deal_title),0,100);?></a>
                                        </h2>
