...
<p id="searchresults">
					...
					<!-- for Product  -->
						 ...
						 ?>		
							...
							<img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/images/products/1000_800' . $p->deal_key . '_1' . '.png'; ?>" border="0" height="50px" width="50px" />
							<?php } else { ?>
						...
						<?php } ?>
						 ...
						 if(strlen($name) > 40) { 
							$name = substr($name, 0, 40) . "...";
                                                ...
                                                <a href="<?php echo PATH.'../../../../application - Copy/views/themes/default/product'.$p->deal_key.'/'.$p->url_title.'.html';?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'../../../../application - Copy/views/themes/default/product'.$p->deal_key.'/'.$p->url_title.'.html';?>" title="<?php echo $this->Lang['ADD_TO_CART']; ?>">
...
<p id="searchresults">
					...
					<!-- for Deal  -->
						 ...
						 ?>
										...
										<span class="category_sub_list">
                                                     <artical class="search_list_img">			
							<a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals' . $d->deal_key . '/' . $d->url_title . '.html'; ?>"  title="<?php echo $d->deal_title; ?>" >
							<?php if (file_exists(DOCROOT . 'images/deals/1000_800/' . $d->deal_key . '_1' . '.png')) { ?>
							
							<img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/images/deals/1000_800' . $d->deal_key . '_1' . '.png'; ?>" border="0" height="50px" width="50px" />
						...
						<?php } ?>
						 ...
						 if(strlen($name) > 40) { 
						    ...
						    <artical class="search_list_info">
                                                <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/deals' . $d->deal_key . '/' . $d->url_title . '.html'; ?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'../../../../application - Copy/views/themes/default/deals'.$d->deal_key.'/'.$d->url_title.'.html';?>" title="<?php echo $this->Lang['BUY_NOW2']; ?>">
...
<!-- for Auction  -->
						...
						<?php  foreach($this->search_category  as $ca ) { 
						 ...
						 ?>
										...
										<span class="category_sub_list">
                                                     <artical class="search_list_img">			
							<a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/auction' . $a->deal_key . '/' . $a->url_title . '.html'; ?>"  title="<?php echo $a->deal_title; ?>" >
							<?php if (file_exists(DOCROOT . 'images/auction/1000_800/' . $a->deal_key . '_1' . '.png')) { ?>
							
							<img src="<?php echo PATH . '../../../../application - Copy/views/themes/default/images/auction/1000_800' . $a->deal_key . '_1' . '.png'; ?>" border="0" height="50px" width="50px" />
						...
						<artical class="search_list_info">
                                                <a href="<?php echo PATH . '../../../../application - Copy/views/themes/default/auction' . $a->deal_key . '/' . $a->url_title . '.html'; ?>"  class="searchheading" > <?php echo $name; ?> </a>
                                                <br>
                                                ...
                                                <span class="search_list_price">
                                                        ...
                                                        <a class="buy_it list_buy_it" href="<?php echo PATH.'../../../../application - Copy/views/themes/default/auction'.$a->deal_key.'/'.$a->url_title.'.html';?>" title="<?php echo $this->Lang['BID_NOW1']; ?>">
