                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                            <td>
                                 <table cellspacing="0" cellpadding="0"  style="width:600px;    border: 1px solid #ECE9E4; background:#fff;">
                                    ...
                                    <tr>
                                        <td width="12px"></td>
                                        <td style="  font:normal 18px arial; color:#ffc367;">			
						...
						<?php echo $this->Lang['YOU_HAVE_RECEIVED']; ?> <?php echo SITENAME; ?>.
                                    ...
                                    <tr style=" height:8"><td></td></tr>
                                      <tr>                   
                                        <td width="15"></td>
                                        <td><p style=" font:bold  12px/25px arial; color:#666;margin:0; padding:0;">Phone : <a style=" font:normal 12px arial; text-decoration: none; color:#333;" title="" ><?php if(isset($_POST['phone'])) { echo $_POST['phone']; } ?></a></p></td>
                                    </tr>
                                    <tr style=" height:8"><td></td></tr>
                                    <tr>                   
                                        <td width="15"></td>
