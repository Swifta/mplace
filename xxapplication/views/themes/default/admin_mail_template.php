                ...
                <td style="padding:15px;">
			        ...
			        <?php } ?>
                                ...
                                <tr height="10">
                                    ...
                                    <tr>
                                        <td>
                                        <?php echo $this->Lang['EMAIL_F']; ?> : <a style=" font:normal 12px/25px arial; color:#ff9b02;" title="<?php if(isset($this->email_id)) { echo $this->email_id; } ?>" ><?php if(isset($this->email_id)) { echo $this->email_id; }  ?></a> 
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    <tr height="10">
