...
<strong style="font-size:20px;font-weight:bold;font-family:Arial;margin-left:20px;color:#666"><?php echo $this->Lang['DEAR']; ?> <?php echo $this->merchant_firstneme; ?> <?php echo $this->merchant_lastname; ?>,</strong><br> 
        ...
        <div style="text-align:center;margin:0 0 20px;padding:10px 0;background:#e2e2e2;">
                        ...
                        <tr>
                            <td>
                                <table class="printtable" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr>
                                                <td colspan="7"><b style="font-size: 15px; font-weight:bold; font-family: Arial;color:#ff9b02;"><?php echo $j.". ".ucfirst($u->deal_title); ?>  </b></td>
                                            </tr>
                                            <tr>
                                                <td colspan="7">&nbsp;</td>
                                            </tr>
                                          ...
                                          ?> 
                                            <tr>
                                                <div style="text-align:center;margin:0 0 20px;padding:10px 0;background:#e2e2e2">
                                                <b style="font-size:12px;font-weight:bold;font-family:Arial;color:#666"><?php echo $this->Lang['BUYERS_NAME']; ?>:</b><b style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"> <?php echo $merchant_firstneme; ?> <?php echo $merchant_lastname; ?> </b><br>
                                                <b style="font-size:12px;font-weight:bold;font-family:Arial;color:#666"><?php echo $this->Lang['BUYERS_EMAIL']; ?>:</b><b style="font-size:12px;font-weight:normal;font-family:Arial;color:#666"> <?php echo $merchant_email; ?> </b>
                                                </div>
                                            </tr>
                                            ...
                                            <td width="13%" align="center"><?php echo CURRENCY_SYMBOL.$u->deal_price; ?></td>
                                            <td width="13%" align="center"><?php echo CURRENCY_SYMBOL.$u->deal_value; ?></td>
			...
			$j++; } ?>
                        ...
                        <div style="width:100%;  line-height: 2em; text-align:left; page-break-before: auto;">
                            ...
                            <div style="float:left; width: 13%; text-align:right; color:#ff9b02; font: bold 12px arial;"><?php echo $this->Lang['SHIP_VAL']; ?></div>
                            ...
                            <div style="float:left; width: 15%; text-align:right; color:#ff9b02; font: bold 12px arial;"><?php echo $this->Lang['SHIP_ING']; ?></div>
                            ...
                            <div style="float:left; width: 15%; text-align:right; color:#ff9b02; font: bold 12px arial;"><?php echo $this->Lang['TAX']; ?></div>
							...
							<table class="printtable" cellpadding="0" cellspacing="0" width="100%">
								 <tr height="30" valign="middle" style="background: #eaeaea;font-size: 12px; font-weight:bold; font-family: Arial;color:#666; width:100%;">
									 <td width="74%">&nbsp;</td>
									 <td width="13%" align="right" style="color:#ff9b02; font: bold 12px arial;"><?php if($p->type == 5) { echo $this->Lang['AMO_TO_B_PAID']; } else { echo $this->Lang['AMTPAID']; } ?></td>
