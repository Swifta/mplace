                        ...
                        <div class="p_inner_block clearfix">
                            ...
                            <div class="payment_form merchant_paymet_form">
                                <ul>
                                 ...
                                 <div class="fullname">
                                 <input type="text" name="storename" class="required" placeholder="<?php echo $this->Lang["STORE_NAME"]; ?>"  value="<?php if(!isset($this->form_error['storename']) && isset($this->userPost['storename'])){echo $this->userPost['storename'];}?>" autofocus />
				<em><?php if(isset($this->form_error['storename'])){ echo $this->form_error["storename"]; }?></em>
                            ...
                            <li>
                             <label><?php echo $this->Lang["PHONE"]; ?>:</label>
                                 <div class="fullname">
									<input type="text" name="mobile" maxlength="15" class="required number" placeholder="<?php echo $this->Lang["PHONE"]; ?>" value="<?php if(!isset($this->form_error['mobile']) && isset($this->userPost['mobile'])){echo $this->userPost['mobile'];}?>"/>
                                 ...
                                 <div class="fullname">
                            <input type="text" name="address1" class="required" value="<?php if(isset($this->userPost['address1'])){echo $this->userPost['address1'];}?>" placeholder="<?php echo $this->Lang["ADDR1"]; ?>" />
				 ...
				 <div class="fullname">				
                            <input type="text" name="address2" class="required" value="<?php if(isset($this->userPost['address2'])){echo $this->userPost['address2'];}?>" placeholder="<?php echo $this->Lang["ADDR2"]; ?>" />
                                ...
                                <li>
                                        ...
                                        <div class="fullname map_loc_section">
                                 ...
                                 <div class="fullname">
									<input type="text" name="zipcode" maxlength="10" class="required number" value="<?php if(!isset($this->form_error['zipcode']) && isset($this->userPost['zipcode'])){echo $this->userPost['zipcode'];}?>" placeholder="<?php echo $this->Lang["ZIP_CODE"]; ?>"/>
									<em><?php if(isset($this->form_error['zipcode'])){ echo $this->form_error["zipcode"]; }?></em>
                                 </div>
                                        </li>
                                    <li>
                                        <label><?php echo $this->Lang["WEBSITE"]; ?>:</label>
                                 <div class="fullname">
									<input type="text" name="website" placeholder="<?php echo $this->Lang["WEBSITE"]; ?>" value="<?php if(!isset($this->form_error['website']) && isset($this->userPost['website'])){echo $this->userPost['website'];}?>"/>
                                ...
                                <div class="merchant_submit_buttons" id="submit32">
                                    <label>&nbsp;</label><input type="submit" value="<?php echo $this->Lang['FINISH'];?>" class="sign_submit" />
