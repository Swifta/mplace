                                ...
                                <div class="categorynew">
                                    ...
                                    <ul>
	                                            ...
	                                            <?php foreach($this->category_list as $category){
                                                        ?>       
                                                        <li><a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/blog/blog/category'.$category->category_url.'.html'?>"><?php echo ucfirst($category->category_name);?></a></li>
                                        <?php  }  ?>
                                    </ul>
                                </div>
                            </div>
...
?> 
    ...
    <a href="<?php echo PATH.'../../../../../application - Copy/views/themes/default/blog/blog'.$popular->url_title.'.html'?>" title="<?php echo $popular->blog_title;?>"><?php if(strlen($popular->blog_title)>100) {
