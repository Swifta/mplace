                            ...
                            <div class="blog_list">
                                ...
                                <div class="post_info">
                                    <ul>
                                        ...
                                        <li><p>|</p></li>
                                        <li>
                                            <p><?php echo $this->Lang['POSTED_BY']; ?>  <?php echo $this->Lang['ADMIN']; ?></p></li><li><p>|</p></li><li><p><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/blog/blog/category' . $blog_details->category_url . '.html' ?>" title="<?php echo ucfirst($blog_details->category_name); ?>" class="post_on_new"><?php echo ucfirst($blog_details->category_name); ?> </a></p>
                                        </li>
                                        <li><p>|</p></li>
                                ...
                                <div class="post_outer">									
                                    <div class="post_right2">	
                                      ...
                                      <i class="wloader_img" >&nbsp;</i>
                                                <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/blog/resize.php';?>?src=<?php echo $imageName; ?>&amp;w=246&amp;h=176"/>
                                            </div>
