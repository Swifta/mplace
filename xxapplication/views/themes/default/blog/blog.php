    ...
    <div class="contianer_inner">
                            ...
                            foreach ($this->blog_list as $blog) {
                                ...
                                <div class="blog_list">
                                    <h3 class="deal_title blog_list_title">
                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/blog/blog' . $blog->url_title . '.html' ?>" title="<?php echo $blog->blog_title; ?>" >
                                    ...
                                    <div class="post_info">
                                        <ul>
                                            ...
                                            <li><p>|</p></li>
                                            <li>
                                                <p><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/blog/blog/category' . $blog->category_url . '.html' ?>" title="<?php echo ucfirst($blog->category_name); ?>" class="post_on_new"><?php echo ucfirst($blog->category_name); ?> </a></p>
                                            </li>
                                            <li>
                                                <p><img src="<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/new/blog_comment.png" width="12" height="12" alt="img" /> <span><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/blog/blog' . $blog->url_title . '.html' ?>#comment_list" title="<?php echo $this->Lang['COMM']; ?>" class="post_on_new"><?php echo $blog->comments_count; ?> <?php echo $this->Lang['COMM']; ?></a></span>
                                                </p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="post_outer">
                                      ...
                                      <i class="wloader_img" >&nbsp;</i>
                                                <a>
                                                <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/blog/resize.php';?>?src=<?php echo $imageName; ?>&amp;w=246&amp;h=176" alt="<?php echo $this->Lang['IMAGE']; ?>" />
        ...
        <?php echo strip_tags(html_entity_decode(ucfirst(substr(($blog->blog_description), 0, 450)))) . "..."; ?></p>
                                            ...
                                            <div class="post_continue_button_outer">
                                                <a class="buy_it" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/blog/blog' . $blog->url_title . '.html' ?>" title="<?php echo $this->Lang['CON_READ']; ?>">
