    ...
    <div class="contianer_outer1">
                    ...
                    <div class="deal_content product_content">
                        <div class="product_image wloader_parent">
                            ...
                            <div class="product_image_inner">
                                ...
                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/images/products/1000_800' . $products->deal_key . '_' . $i . '.png'; ?>" class="MagicZoomPlus" id="Zoomer3" rel="zoom-position: inner; selectors-change: mouseover; selectors-mouseover-delay:70; selectors-effect: fade" title="">
                                    <?php if(($size[0] > PRODUCT_DETAIL_WIDTH) && ($size[1] > PRODUCT_DETAIL_HEIGHT)) { ?>
                                        <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo PRODUCT_DETAIL_WIDTH; ?>" />
                                        <?php } else { ?>
                                          <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/images/products/1000_800' . $products->deal_key . '_' . $i . '.png' ?>" />
                                        <?php } ?>
        ...
        <?php } ?>
								...
								<span <?php if($k>3){ ?>class="MagicScroll" id="ZoomScroll" <?php } ?>>
									...
									?>
									<?php if(($size[0] > PRODUCT_DETAIL_WIDTH) && ($size[1] > PRODUCT_DETAIL_HEIGHT)) { ?>
										<a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/images/products/1000_800' . $products->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_' . $i . '.png'; ?>&w=<?php echo PRODUCT_DETAIL_WIDTH; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo PRODUCT_THUMB_WIDTH; ?>&amp;h=<?php echo PRODUCT_THUMB_HEIGHT; ?>" />
                <?php /* <img src="<?php echo PATH.'images/products/100_100/'.$products->deal_key.'_'.$i.'.png';?>"/> */ ?></a>
                
                                                                        <?php } else { ?>
                                                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/images/products/1000_800' . $products->deal_key . '_' . $i . '.png'; ?>" rel="zoom-id:Zoomer3" rev="<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_' . $i . '.png'; ?>" title="">
                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/resize.php'; ?>?src=<?php echo PATH . 'images/products/1000_800/' . $products->deal_key . '_' . $i . '.png' ?>&amp;w=<?php echo PRODUCT_THUMB_WIDTH; ?>&amp;h=<?php echo PRODUCT_THUMB_HEIGHT; ?>" /></a>
                                                                        <?php } ?>
										<?php } } ?>
									<?php } ?>
								</span>
    ...
    <?php } ?>
                           ...
                           <div class="clearfix">
                            ...
                            <div class="deal_share clearfix">
                                <div class="social_share">
                                    <ul>
                                        <li>  <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?> &amp;layout=button_count&amp;show_faces=true&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden;  height:21px; width:82px;" allowTransparency="true"></iframe></li>
                                        <li>
                                            <script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
                                            <a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" data-count="horizontal"><?php echo $this->Lang['TWEET']; ?></a></li>
                                        ...
                                        <li> <script type="text/javascript" src="https://apis.google.com/js/plusone.js">
                                            ...
                                            <div class="g-plusone" data-size="medium" data-href="<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?>"></div>
                    ...
                    <div class="deal_comment_block">
                        <div class="deal_address">
                            ...
                            <address class="deal_map_address">
                                <h3><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/stores' . $products->store_key . '/' . $products->store_url_title . '.html'; ?>" title="<?php echo $products->store_name; ?>"><?php echo $products->store_name; ?></a></h3>
                        ...
                        <div class="fbok_comment_block">
                            ...
                            <div class="fbok_comment wloader_parent">
                                ...
                                <div width="370" class="fb-comments" data-href="<?php echo PATH . 'product/' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" data-num-posts="10" ></div>
                            </div>
                        </div>
                    </div>
            ...
            foreach ($this->all_products_list as $products_list) {
                ...
                <?php } else { ?>
                                                                ...
                                                                <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $products_list->deal_key . '/' . $products_list->url_title . '.html'; ?>" title="<?php echo $products_list->deal_title; ?>">
                                                                   <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/products/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $products->deal_title; ?>" title="<?php echo $products->deal_title; ?>" />
                                                                </a>
                <?php } ?>
