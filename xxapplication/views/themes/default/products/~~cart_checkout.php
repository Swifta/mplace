...
?> <?php echo $this->Lang['PRO_SH_CA']; ?>.</p>*/ ?>   
            ...
            <?php } ?> 
                                        ...
                                        <?php } ?>>                                                                        
                                                    <h3 class="cart_desc_title"><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>"><?php echo $products->deal_title; ?></a></h3>
            ...
            <?php } ?>
                                            ...
                                            <td align="center">
                                                <a class="cart_delete" id="prodele_<?php echo $products->deal_id; ?>" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/payment_product/cart_remove/product_cart_id' . $value; ?>" title="<?php echo $this->Lang['RMV']; ?>">&nbsp;</a>
                                            </td>
                                                <script>
