                                                ...
                                                <?php foreach ($this->product_compare as $c) {  ?>
                                                    <td class="name" valign="top;">  
                                                        <div class="produt_compare_title clearfix">
                                                            <a class="compare_deal_title" title="<?php echo $c['deal_title']; ?>" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $c['deal_key'] . '/' . $c['url_title']; ?>.html"><?php echo $c['deal_title']; ?></a>                                                        
                                                            <a class="close_compare_deal" href="<?php echo PATH; ?>products/remove_compare/?product_id=<?php echo $c['../../../../../application - Copy/views/themes/default/products/deal_id']; ?>" title="<?php echo $this->Lang['RMV'] ?>" >&nbsp;</a>
                                                        </div>
                                                        <div class="product_compare_image_sec">
                                                            ...
                                                            <?php if (file_exists(DOCROOT . 'images/products/1000_800/' . $c['deal_key'] . '_1.png')) { ?>
                                                                <img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/resize.php'; ?>?src=<?php echo PATH . '/images/products/1000_800/' . $c['deal_key'] . '_1.png' ?>&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>"  alt="<?php echo $c['deal_title']; ?>">
                                                            <?php } else { ?>
                                                                <img src="<?php echo PATH.'../../../../../application - Copy/views/themes/default/products/resize.php';?>?src=<?php echo PATH; ?>themes/<?php echo THEME_NAME; ?>/images/noimage_products_list.png&amp;w=<?php echo PRODUCT_LIST_WIDTH; ?>&amp;h=<?php echo PRODUCT_LIST_HEIGHT; ?>" alt="<?php echo $c['deal_title']; ?>" title="<?php echo $c['deal_title']; ?>" />
                                                            <?php } ?>
                                                            </div>                                                        
                                                            <a class="buy_it compare_view_it" href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $c['deal_key'] . '/' . $c['url_title'] . '.html'; ?>" title="<?php echo $this->Lang['VIEW_PRODUCT']; ?>"><?php echo $this->Lang['VIEW_PRODUCT']; ?></a>
                                                        </div>
                                                    </td>
                                                    <?php  }  ?>
                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td ><p class="c_row_title"><?php echo $this->Lang['RATING']; ?></p></td>
                                                ...
                                                foreach ($this->product_compare as $c) {
                                                    ?>
                                                <td><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/themes' . THEME_NAME . '/images/stars-' . $c['rating']; ?>.png" alt="<?php echo $this->Lang['BASED_ON'] . " " . $c['rating_count'] . " " . $this->Lang['REVIWS']; ?>">
