                                            ...
                                            if ((is_string($value)) && ($key == 'product_cart_id' . $value)) {
                                                ...
                                                foreach ($this->get_cart_products as $products) {
                                                    ...
                                                    <tr id="cart_item_<?php echo $value; ?>">
                                                        ...
                                                        <a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $products->deal_title; ?>"><img src="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/images/products/1000_800' . $products->deal_key . '_1' . '.png'; ?>"  alt="<?php echo $products->deal_title; ?>" title="<?php echo $products->deal_title; ?>" width="80" height="80"></a>
                                                        <?php } else { ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <h4 class="cart_desc_title"><a href="<?php echo PATH . '../../../../../application - Copy/views/themes/default/products/product' . $products->deal_key . '/' . $products->url_title . '.html'; ?>" title="<?php echo $products->deal_title; ?>"><?php echo $products->deal_title; ?></a></h4>
