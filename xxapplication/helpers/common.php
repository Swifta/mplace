...
class common{
	...
	public function get_deal_count($store_id = "",$type="")
	{
		...
		if($type==1) {
		$this->get_deals_categories = $this->stores->get_deals_categories($store_id);
		...
		if($type==2) {
		$this->get_product_categories = $this->stores->get_product_categories($store_id);
		...
		if($type==3) {
		$this->get_auction_categories = $this->stores->get_auction_categories($store_id);
