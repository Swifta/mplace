...
require_once('../../../../application - Copy/vendor/pdf/config/lang/eng.php');

// load alternative config file
require_once('../../../../application - Copy/vendor/pdf/config/tcpdf_config_alt.php');
define("K_TCPDF_EXTERNAL_CONFIG", true);

require_once('../../../../application - Copy/vendor/pdf/tcpdf.php');
