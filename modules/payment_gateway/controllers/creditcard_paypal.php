...
class Creditcard_paypal_Controller extends Layout_Controller
{
	...
	public function __construct()
	{
		...
		foreach($this->generalSettings as $s){
			...
			$this->Api_Username = 'ppounds1-facilitator_api1.gmail.com';///$s->paypal_account_id;
			$this->Api_Password = 'CESFP7CKLFHBUZJS';//$s->paypal_api_password;
			$this->Api_Signature = 'AFcWxV21C7fd0v3bYYYRCpSSRl31ANRGue0ZsHIfEL6FBAH2ywsO4gwQ';//$s->paypal_api_signature;
	...
	public function dodirectpayment()
	{
		...
		foreach($_SESSION as $key=>$value)
				...
				foreach($_SESSION as $key=>$value)
                {
			        ...
			        $transaction = $this->creditcard_paypal_pay->insert_transaction_details($this->result, $deal_id, $country_code, $firstName, $lastName, $referral_amount, $qty, 1, $captured, $purchase_qty, arr::to_object($this->userPost),$merchant_id,$friend_gift, $friendName, $friendEmail, $product_size,$product_color,$tax_amount,$shipping_amount,$deal_amount,$shipping_methods);
...
if($_POST){
	...
	public function authorize($deal_id = "", $friend_name= "",$friend_email = "", $friend_gift_status = "", $adderss1= "", $adderss2 = "", $state = "", $city= "",$country = "", $shipping_name = "", $postal_code= "",$phone = "",$pay_amount1=0)
	{
