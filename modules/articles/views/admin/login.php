     ...
     <div class="login_cont_mid"> 
		<div class="login_container">
                ...
                <div class="login_form">
                	<h1><?php if(isset($this->is_merchat)){echo  $this->Lang["MERCHANT_LOGIN_TITLE"];}else{echo $this->Lang["VIEW_LOGIN_TITLE"]; }?></h1><?php if(isset($this->error_login)){ ?><span class="login_error"><?php echo $this->error_login; ?></span><?php } ?>
                    <div class="form">
                    <form action="" method="post">
                        <table  cellpadding="5"  cellspacing="5" width="260" >
                          ...
                          <td class="login_forget"> <?php if(isset($this->is_merchat)){?> <span style="cursor:pointer; color:white;" >
<a onclick="window.location.href='<?php echo PATH; ?>merchant/forgot-password.html'" title="<?php echo $this->Lang['FORGOT_PASS']; ?>"> <?php echo $this->Lang['FORGOT_PASS']; ?></a> </span><?php }else{ }?>   </td>
                          </tr> 
