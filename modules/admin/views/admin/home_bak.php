    ...
    <div class="content_middle">
  		<div class="admin_menu">
			 ...
			 <li>
                     ...
                     <img src="<?php echo PATH ?>images/merchant.png" class="image" alt="<?php echo $this->Lang['MERCHANTS']; ?>"/>
...
$(document).ready(function() {
	chart = new Highcharts.Chart({
		...
		title: {
			text: '<?php echo $this->Lang["TOT_CUS_MER"]; ?>'
		},
