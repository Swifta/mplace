		...
		<tr>
                ...
                $shippinglist = $this->products->get_shipping_data($_POST['users']);
                       ...
                       <tr>
                                ...
                                <table style="border: 1px solid #999; border-collapse: collapse; width:242px;">
                                        ...
                                        <tr><td><input type="radio" name="shipping" value="5" <?php if(!isset($this->form_error['users']) && isset($_POST['users'])){ if($_POST['shipping'] == 5){ ?> checked <?php } } ?> id="productaramex" onchange="return checkedaramex(this)">Aramex Shipping</td></tr>
                                        <?php } ?>
                                        </table>
                                </td>
                        </tr>
		 ...
		 <input type="radio" name="autopost" <?php if($this->session->get("facebook_status")==1) {?> checked <?php } ?>  value="1" ><?php echo $this->Lang['YES']; ?> 
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>"  id="check2"/><input type="button" value="<?php echo $this->Lang['RESET']; ?>" onclick="javascript:window.location='<?php echo PATH; ?>admin/add-products.html'"/></td>
                </tr>
