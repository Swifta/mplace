...
<?php /* <img border="0" src= "<?php echo PATH.'images/products/290_215/'.$u->deal_key.'_1'.'.png';?>" alt="" width="80" />*/ ?></td>
		        ...
		        <?php } ?>
                    <?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <a href="<?php echo PATH.'admin/edit-products/'.base64_encode($u->deal_id).'/'.$u->deal_key.'.html';?>" class="editicon" title="<?php echo $this->Lang['EDIT_PRODUCT']; ?>"></a>
    		...
    		<td align="left" id="popu_<?php echo $u->deal_id; ?></td>"><input type="checkbox" <?php if($u->deal_feature == 1) { ?> checked <?php } ?> id="popular<?php echo $u->deal_id; ?>" value="<?php echo $u->deal_id; ?>" onclick="popular_product(this.value,this)" /></td>

                  <?php } ?>
                  
                  <td align="left">
                    <a href="<?php echo PATH.'product/'.$u->deal_key.'/'.$u->url_title.'/admin-preview.html';?>" class="previewicon" title="<?php echo 'Preview'; ?>" target="_blank"></a>
                    </td>
