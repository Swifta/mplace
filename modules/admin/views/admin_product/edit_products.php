...
<?php /* <div class="chart_2 fl">
    ...
    <div class="content_middle">
        <form action="" method="post" class="admin_form" enctype="multipart/form-data" onSubmit="return validate();" id="yourFormId" >
        ...
        if (input.files && input.files[0]) {
            ...
            reader.readAsDataURL(input.files[0]);
               ...
               <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>"  id="check2"/><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>admin/manage-products.html"'/></td>
                </tr><?php }?>
