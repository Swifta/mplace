        ...
        <table class="list_table fl clr">
            ...
            <?php   $i=0; $first_item = $this->pagination->current_first_item; 
                ...
                <tr>
                    ...
                    <td><a href="<?php echo PATH.'admin/edit-attribute-group/'.base64_encode($c->attribute_group_id).'.html'; ?>" class="editicon" title="<?php echo $this->Lang['EDIT_ATTR_GROUP']; ?>"></a></td>
                    <td>
