						...
						<table  cellspacing="0" cellpadding="0">
							<tr>
								...
								<td style="font-family:arial; font-size:24px; color:#fff; background:#1d95d0; text-align:center; font-weight:bold; padding-top:10px; padding-left:15px; padding-right:15px; padding-bottom:10px;">
									<a href="<?php echo PATH.'auction/'.$this->deal_deatils['deal_key'].'/'.$this->deal_deatils['url_title'].'.html';?>" title="<?php echo $this->Lang['VIEW_DL']; ?>" style="color:#fff; text-decoration:none;"><?php echo $this->Lang['VIEW_TH_AU']; ?></a>
