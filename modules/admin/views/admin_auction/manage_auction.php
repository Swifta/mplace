		...
		<a title="Email to register users" href="<?php echo PATH.'admin-auction/send-auction-email/'.$u->deal_id.'/'.$u->deal_key.'.html';?>"><img src="<?php echo PATH;?>images/mail.png"></a></td> <?php } else{ echo "<td>---</td>"; }?>
			...
			<?php if($u->auction_status == 2) { echo "---"; } else { ?>
                   ...
                   <?php if($u->deal_status == 1 && $u->store_status==1){ ?>
                    ...
                    <td align="left" id="popu_<?php echo $u->deal_id; ?></td>"><input type="checkbox" <?php if($u->deal_feature == 1) { ?> checked <?php } ?> id="popular<?php echo $u->deal_id; ?>" value="<?php echo $u->deal_id; ?>" onclick="popular_auction(this.value,this)" /></td>
                    <?php } ?>
					<td align="left">
                    <a href="<?php echo PATH.'auction/'.$u->deal_key.'/'.$u->url_title.'/admin-preview.html';?>" class="previewicon" title="<?php echo $this->Lang['PREVIEW']; ?>" target="_blank"></a>
                    </td>
