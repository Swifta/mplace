...
<?php  if(($this->uri->segment(2)=='view-deal')){	
		...
		<a class="fr" style="float:right;text-decoration: underline; cursor: pointer;position:relative; z-index:2;" href="<?php echo PATH.'admin/view-deal/'.$this->deal_key.'/'.$this->deal_id.'.html?id='.$this->Lang['SEARCH'];  ?>" title="<?php echo $this->Lang['EXP_DL']; ?>"><img src="<?php echo PATH ?>images/csv.png" class="image" alt="<?php echo $this->Lang['EXP_DL']; ?>"/></a>
