...
<?php /* <img border="0" src= "<?php echo PATH.'images/deals/220_160/'.$u->deal_key.'_1'.'.png';?>" alt="" width="80" /> */ ?></td>
                       ...
                       <?php  if(($this->uri->last_segment() == 'manage-deals.html') && $u->deal_status == 1) { ?> <td>
                        ...
                        <td align="left" id="popu_<?php echo $u->deal_id; ?></td>"><input type="checkbox" <?php if($u->deal_feature == 1) { ?> checked <?php } ?> id="popular<?php echo $u->deal_id; ?>" value="<?php echo $u->deal_id; ?>" onclick="popular_deals(this.value,this)" /></td>
                        <?php }  ?>
                        <td align="left">
                        <a href="<?php echo PATH.'deals/'.$u->deal_key.'/'.$u->url_title.'/admin-preview.html';?>" class="previewicon" title="<?php echo $this->Lang['PREVIEW']; ?>" target="_blank"></a>
                        </td>
