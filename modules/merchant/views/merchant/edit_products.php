            ...
            reader.readAsDataURL(input.files[0]);
			  ...
			  <!-- attribute end -->
               ...
               <tr>
                    <td></td>
                    <td></td>
                    <td><input type="submit" value="<?php echo $this->Lang['SUBMIT']; ?>" class="check2" id="check2"/><input type="button" value="<?php echo $this->Lang['CANCEL']; ?>" onclick='window.location.href="<?php echo PATH?>merchant/manage-products.html"'/></td>
                </tr><?php }?>
