    ...
    <div class="content_middle">
     ...
     <form method="get" class="admin_form fl" action="<?php echo PATH.$this->url;?>">
		...
		<?php } ?>
			...
			<?php if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <a href="<?php echo PATH.'merchant/edit-products/'.base64_encode($u->deal_id).'/'.$u->deal_key.'.html';?>" class="editicon" title="<?php echo $this->Lang['EDIT_PRODUCT']; ?>"></a>
                    </td>
          <?php } ?>
					<td align="left">
                    <a href="<?php echo PATH.'product/'.$u->deal_key.'/'.$u->url_title.'/merchant-preview.html';?>" class="previewicon" title="<?php echo $this->Lang['PREVIEW']; ?>" target="_blank"></a>
                    </td>
                    <?php /* if(($this->uri->last_segment() == 'manage-products.html')||($this->uri->segment(2) == 'manage-products.html')){ ?> 
                    <td align="left">
                    <?php if($u->deal_status == 1){?>
