...
class Deals_Controller extends Layout_Controller
{
	...
	public function search_list( $page = "")
	{
		...
		$this->template->title = rtrim($this->Lang['DEALS'].'/'.$search." | ".SITENAME);
		$this->title_display = rtrim($this->Lang['DEALS'].'/'.$search);
		$this->template->content = new View("themes/".THEME_NAME."/deals/today_deals");
	}
	...
	public function details_deals($deal_key = "", $url_title = "",$type = "")
	{
		$this->is_todaydeals = 1;
                $this->is_details = 1;
